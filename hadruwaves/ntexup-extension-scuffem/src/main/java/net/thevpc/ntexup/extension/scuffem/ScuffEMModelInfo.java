...
public class ScuffEMModelInfo {

    public static class ScuffEMBox {
    ...
    public List<ScuffEMBox> antennaBoxes = new ArrayList<>();
    public List<ScuffEMBox> sourceBoxes = new ArrayList<>();
}
