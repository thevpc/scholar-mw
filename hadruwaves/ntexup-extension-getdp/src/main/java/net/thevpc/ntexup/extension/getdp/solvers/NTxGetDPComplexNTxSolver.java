...
public abstract class NTxGetDPComplexNTxSolver extends NTxSolverRunImpl {
    private NTxSweep sweep;
    private NTxSweepTarget sweepParam;

    public NTxGetDPComplexNTxSolver(String computeName, String solverName, String solverType, NTxSimulationPlan plan) {
    ...
    public List<NTxSimulationResult> execute() {
        GetDPStrNTxSimulationPlan plan = (GetDPStrNTxSimulationPlan) plan();
        plan.ensureFemSolved();
    ...
    protected abstract Complex evalComplex(GetDPStrNTxSimulationPlan plan, double freq);
}
