...
public class NTxHwMatrixCurrentSolver extends NTxHwSpaceComplexMatrixNTxSolver {
    public NTxHwMatrixCurrentSolver(String computeName, String solverName, MoMStrNTxSimulationPlan moMStrSimulationQuery) {
