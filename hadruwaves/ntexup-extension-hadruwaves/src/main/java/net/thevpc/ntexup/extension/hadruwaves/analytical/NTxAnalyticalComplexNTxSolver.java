...
public abstract class NTxAnalyticalComplexNTxSolver extends NTxSolverRunImpl {
    private NTxSweep sweep;
    private NTxSweepTarget sweepParam;

    public NTxAnalyticalComplexNTxSolver(String computeName, String solverName, String solverType, NTxSimulationPlan plan) {
    ...
    public List<NTxSimulationResult> execute() {
        AnalyticalStrNTxSimulationPlan plan = (AnalyticalStrNTxSimulationPlan) plan();
    ...
    protected abstract Complex evalComplex(AnalyticalStrNTxSimulationPlan plan, double freq);
}
