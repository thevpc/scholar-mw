...
public class NTxHwMatrixASolver extends NTxHwComplexMatrixNTxSolver {

    public NTxHwMatrixASolver(MoMStrNTxSimulationPlan moMStrSimulationQuery, String computeName, String solverName) {
