...
public class NTxQucsBuilder implements NTxNodeBuilder {

    @Override
    public void build(NTxNodeBuilderContext builderContext) {
        builderContext.id("qucs-solver")
                .alias("qucs", "qucs-core", "qucsator", "qucsSolver")
        ...
        NTxMwSimulationUtils.doRender(rendererContext,
                new NTxStrSimulationQueryFactory() {
                    ...
                    public NTxSimulationPlan newInstance(String id, String name, NTxFunctionCallContext args) {
                        QucsStrNTxSimulationPlan plan = new QucsStrNTxSimulationPlan(id, name, rendererContext);
                        plan.modelInfo = QucsParser.parse(args);
                        return plan;
                    }
                });
    }
