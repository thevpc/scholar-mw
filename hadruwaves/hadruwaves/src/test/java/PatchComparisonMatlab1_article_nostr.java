...
//            Vector<Expr> exprs1 = (vscalarProduct(Xp.toVector().to($EXPR), sp.columns()));
//            Vector<Expr> exprs = columnEVector(exprs1.size(), (i) -> exprs1.get(i).toComplex());
