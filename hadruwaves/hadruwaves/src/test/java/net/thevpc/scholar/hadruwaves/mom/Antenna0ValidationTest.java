...
public class Antenna0ValidationTest {
...
//        double L = 38.8*Maths.MM;                          // ≈ 16.25 mm (resonant dimension)
        ...
        // === DOMAIN & Maths ===
        double pad = 50 * Maths.MM;  // Explicit padding to avoid boundary effects
        double xmin = -W / 2 - pad;
...
//        );
        ...
        // === BOUNDARIES ===
        mom.setFirstBoxSpace(BoxSpace.shortCircuit(Material.substrate("FR4", er), h));  // PEC ground at y=0, substrate h=1mm
        ...
        mom.setSources(new DefaultPlanarSources(
                new CstPlanarSource(500, 500, Complex.of(50), Axis.Y,
                        new DefaultHGeometryList(source, new DefaultHPolygon(source)))));
