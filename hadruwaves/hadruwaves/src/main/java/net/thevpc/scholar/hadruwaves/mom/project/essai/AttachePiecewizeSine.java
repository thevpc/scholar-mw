package net.thevpc.scholar.hadruwaves.mom.project.essai;

//package net.thevpc.scholar.tmwlib.mom.planar.essai;
//
//import net.thevpc.params.Configuration;
//import net.thevpc.scholar.math.functions.dfxy.DFunctionVector2D;
//import net.thevpc.scholar.math.functions.dfxy.PiecewiseSineXFunctionXY;
//import net.thevpc.scholar.math.functions.FunctionFactory;
//import net.thevpc.scholar.math.Axis;
//import net.thevpc.scholar.tmwlib.mom.planar.common.AreaManager;
//import net.thevpc.scholar.tmwlib.mom.planar.common.MetalArea;
//
///**
// * User: taha
// * Date: 3 juil. 2003
