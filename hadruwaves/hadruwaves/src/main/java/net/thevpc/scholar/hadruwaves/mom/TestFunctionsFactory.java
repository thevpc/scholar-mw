...
public class TestFunctionsFactory extends AbstractFactory {
    ...
    public static TestFunctionsBuilder addGeometry(HPoint... points) {
    ...
    public static TestFunctionsBuilder addGeometry(HGeometry geometry) {
    ...
    public static GpRWG createRWG(HGeometry geometry, MeshTriangulationOptions trianglesCount) {
        return new GpRWG(GeometryFactory.createPolygonList(geometry), trianglesCount);
    }

    public static GpAdaptiveMesh createRooftops(HGeometry geometry, MeshZoneTypeFilter meshZoneTypeFilter, Axis invariance, TestFunctionsSymmetry gpSymmetry, GridPrecision gridPrecision) {
    ...
    public static GpAdaptiveMesh createRectangularGates(HGeometry geometry, TestFunctionsSymmetry gpSymmetry, GridPrecision gridPrecision) {
    ...
    public static GpAdaptiveMesh createTriangularGates(HGeometry geometry, int trianglesCount, TestFunctionsSymmetry gpSymmetry) {
    ...
    public static GpAdaptiveMesh createBoxModes(HGeometry geometry, int complexity, boolean inheritInvariance, Axis axisInvariance, int[] includedModes, int[] excludedModes, TestFunctionsSymmetry gpSymmetry, GridPrecision gridPrecision) {
    ...
    public static GpAdaptiveMesh createArcheSinus(HGeometry geometry, MeshZoneTypeFilter meshZoneTypeFilter, double factor, Axis axisInvariance, int[] includedModes, int[] excludedModes, TestFunctionsSymmetry gpSymmetry, GridPrecision gridPrecision) {
    ...
    public static GpAdaptiveMesh createPolyhedron(HGeometry geometry, int gridx, int gridy, Axis axisInvariance, TestFunctionsSymmetry gpSymmetry, GridPrecision gridPrecision) {
    ...
    public static GpAdaptiveMesh createSicoCoco(HGeometry geometry, int complexity, TestFunctionsSymmetry gpSymmetry, GridPrecision gridPrecision) {
    ...
    public static GpAdaptiveMesh createSicoCosi(HGeometry geometry, int complexity, TestFunctionsSymmetry gpSymmetry, GridPrecision gridPrecision) {
    ...
    public static GpAdaptiveMesh createSisiSisi(HGeometry geometry, int complexity, TestFunctionsSymmetry gpSymmetry, GridPrecision gridPrecision) {
...
//                }
                ...
                case "rwg": {
                    ...
                    return NOptional.of(TestFunctionsFactory.createRWG(geometry,
                            new MeshTriangulationOptions()
                                    .setMaxCount(count)
            ...
            return NOptional.<TestFunctions>ofError(NMsg.ofC("invalid test/basis functions %s", value).asError()).withDefault(() -> {
                HGeometry defaultGeometry = _resolveGeometry(null, geometryResolver).orNull();
                if (defaultGeometry == null) {
                    return createList();
                }
                return createRWG(defaultGeometry, new MeshTriangulationOptions());
            });
    ...
    private static NOptional<HGeometry> _resolveGeometry(NElement pv, Function<NElement, HGeometry> geometryResolver) {
        HGeometry geometry = geometryResolver.apply(pv);
        if (geometry == null) {
            if (pv == null) {
