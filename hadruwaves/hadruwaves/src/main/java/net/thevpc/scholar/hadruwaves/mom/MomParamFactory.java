...
import net.thevpc.scholar.hadruplot.console.params.*;
...
import net.thevpc.scholar.hadruwaves.console.params.FreqParam;
import net.thevpc.scholar.hadruwaves.console.params.OmegaParam;
import net.thevpc.scholar.hadruplot.PlotConstantMatrix;
import net.thevpc.scholar.hadruwaves.console.plot.PlotConstantVDiscrete;
import net.thevpc.scholar.hadruplot.model.value.PlotValueMatrix;
import net.thevpc.scholar.hadruplot.console.ConsoleParams;
import net.thevpc.scholar.hadruwaves.console.plot.PlotValueVDiscrete;
import net.thevpc.scholar.hadruwaves.console.yaxis.*;
import net.thevpc.scholar.hadruwaves.mom.console.params.*;
import net.thevpc.scholar.hadruwaves.mom.console.params.hints.*;
import net.thevpc.scholar.hadruwaves.mom.console.yaxis.*;
...
//        }
        ...
        public static ArrayParamSet<TestFunctions> testFunctions(net.thevpc.scholar.hadruwaves.mom.TestFunctions[] functions) {
        ...
        public static ArrayParamSet<ModeFunctions> modeFunctions(net.thevpc.scholar.hadruwaves.mom.ModeFunctions[] functions) {
