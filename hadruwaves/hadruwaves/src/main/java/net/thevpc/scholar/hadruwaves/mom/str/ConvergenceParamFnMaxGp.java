...
// */
//
//package net.thevpc.scholar.tmwlib.mom.str;
//
//import java.util.Map;
//
//import net.thevpc.scholar.math.convergence.*;
//import net.thevpc.scholar.math.util.ProgressMonitor;
//import net.thevpc.scholar.tmwlib.mom.MomStructure;
//import net.thevpc.scholar.tmwlib.mom.TestFunctions;
//
//
///**
// *
...
//    }
//
//    public net.thevpc.scholar.tmwlib.mom.TestFunctions[] getIteratedParams() {
