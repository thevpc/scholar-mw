...
import net.thevpc.scholar.hadruwaves.mom.util.MomUtils;
...
public class VarEvaluator {
    ...
    public Object evaluate(String expr, VarUnit unit, int depth) {
        ...
        while (true) {
            try {
                Object n = parser.evaluate(expr,null);
    ...
    private abstract class SubStrJFunction extends JFunctionBase {
        ...
        public SubStrJFunction(String name, Class type, JTypes types) {
            super(name, types.forName(type.getName()),
                    new JType[]{types.forName(String.class.getName())},null);
        }
        ...
        public Object invoke(JInvokeContext context) {
            ...
            try {
                String n = (String) context.evaluate(context.getArguments()[0]);
            ...
            Object[] args = context.evaluate(context.getArguments());
            return evaluate(str, args, context.getContext());
        }
        @Override
        public String getSourceName() {
            return "VarEvaluator.class";
        }

        @Override
        public JType getGenericReturnType() {
            return getTypes().typeOf(Complex.class.getName());
        }
