...
public class TmwlibExample {
    public static void main(String[] args) {
        ...
        double W = 5.989 * MM ; double att = 2 * l / 1.2 ;  Domain box = forWidth(0, a, -b / 2, b);
        double f = 4.79 * GHZ ; int modes = 1000000 ;double substrateEpsr = 2.2;double superstrateEpsr = 1;
