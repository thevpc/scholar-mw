...
public class TestFunctionsBuilder {
    ...
    public net.thevpc.scholar.hadruwaves.mom.TestFunctions build() {
...
//        }
    ...
    public net.thevpc.scholar.hadruwaves.mom.TestFunctions buildRWGs() {
    ...
    public net.thevpc.scholar.hadruwaves.mom.TestFunctions buildRectangularGates() {
    ...
    public net.thevpc.scholar.hadruwaves.mom.TestFunctions buildTriangularGates() {
    ...
    public net.thevpc.scholar.hadruwaves.mom.TestFunctions buildMesh() {
    ...
    public net.thevpc.scholar.hadruwaves.mom.TestFunctions buildBoxModes() {
    ...
    public net.thevpc.scholar.hadruwaves.mom.TestFunctions buildArchSine() {
    ...
    public net.thevpc.scholar.hadruwaves.mom.TestFunctions buildSine(String borders, int m, int n) {
    ...
    public net.thevpc.scholar.hadruwaves.mom.TestFunctions buildPolyhedron() {
    ...
    public net.thevpc.scholar.hadruwaves.mom.TestFunctions buildSicoCoco() {
    ...
    public net.thevpc.scholar.hadruwaves.mom.TestFunctions buildSicoCosi() {
    ...
    public net.thevpc.scholar.hadruwaves.mom.TestFunctions buildSisiSisi() {
    ...
    private net.thevpc.scholar.hadruwaves.mom.TestFunctions normalizeIfApplicable(net.thevpc.scholar.hadruwaves.mom.TestFunctions f) {
        if (f == null) {
            return null;
        }
        if (normalized) {
    ...
    private TestFunctionsBuilder apply(net.thevpc.scholar.hadruwaves.mom.TestFunctions fct) {
