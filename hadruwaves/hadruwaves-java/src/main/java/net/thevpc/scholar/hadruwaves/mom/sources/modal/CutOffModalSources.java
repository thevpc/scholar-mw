 ...
 */
public class CutOffModalSources extends AbstractPropagatingModalSources implements Cloneable{
    public CutOffModalSources(int defaultSourceCount, int... sourceCountPerDimension) {
