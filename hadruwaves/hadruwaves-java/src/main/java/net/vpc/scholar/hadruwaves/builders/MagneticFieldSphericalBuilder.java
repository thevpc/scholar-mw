 ...
 */
public interface MagneticFieldSphericalBuilder extends SphericalFieldBuilder {
    MagneticFieldSphericalBuilder monitor(ProgressMonitorFactory monitor);

    MagneticFieldSphericalBuilder monitor(ProgressMonitor monitor);

    MagneticFieldSphericalBuilder converge(ConvergenceEvaluator convergenceEvaluator);
