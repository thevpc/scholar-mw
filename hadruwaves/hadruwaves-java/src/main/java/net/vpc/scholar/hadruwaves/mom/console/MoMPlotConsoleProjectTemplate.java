//package net.vpc.scholar.tmwlib.mom.console;
//
//import net.vpc.scholar.math.Domain;
//import net.vpc.scholar.math.geom.DefaultGeometryList;
//import net.vpc.scholar.math.geom.GeometryList;
...
//import net.vpc.scholar.math.plot.console.*;
//import net.vpc.scholar.math.plot.console.paramsets.DoubleArrayParamSet;
//import net.vpc.scholar.math.plot.console.paramsets.ParamSet;
//import net.vpc.scholar.math.plot.console.yaxis.YType;
//import net.vpc.scholar.tmwlib.console.paramsets.FreqParam;
//import net.vpc.scholar.tmwlib.mom.CircuitType;
//import net.vpc.scholar.tmwlib.mom.TestFunctionsSymmetry;
//import net.vpc.scholar.tmwlib.mom.console.paramsets.*;
//import net.vpc.scholar.tmwlib.mom.console.paramsets.hints.*;
//import net.vpc.scholar.tmwlib.mom.modes.FnEMEMXY;
//import net.vpc.scholar.tmwlib.mom.testfunctions.gpmesh.GpAdaptiveMesh;
//import net.vpc.scholar.tmwlib.mom.testfunctions.gpmesh.gppattern.GpPattern;
//import net.vpc.scholar.tmwlib.mom.GpPatternFactory;
