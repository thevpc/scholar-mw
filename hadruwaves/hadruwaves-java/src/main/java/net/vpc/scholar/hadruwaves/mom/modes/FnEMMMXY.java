...
// */
//@Deprecated
//public class FnEMMMXY extends ModeFunctionsBase {
//
//
//    public FnEMMMXY() {
//        super(false, WallBorders.EMMM);
//    }
//
//
//    @Override
...
//        return new Complex(sqr(n.m * PI / domain.xwidth()) + sqr(((2.0 * n.n + 1) / 2.0) * PI / domain.ywidth()) - sqr(cachedk0) * bs.getEpsr()).sqrt();
//    }
//
//
//    @Override
...
////            boolean ix=fn.isInvariant(Axis.X);
////            boolean iy=fn.isInvariant(Axis.Y);
//            fn=(DoubleToVector) fn.setName("EMEM" + i);
//        }
//        return fn;
//    }
