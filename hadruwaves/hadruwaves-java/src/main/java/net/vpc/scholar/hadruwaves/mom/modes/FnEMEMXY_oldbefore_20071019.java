...
// */
//@Deprecated
//public class FnEMEMXY_oldbefore_20071019 extends ModeFunctionsBase {
//
//
//    public FnEMEMXY_oldbefore_20071019() {
//        super(false, WallBorders.EMEM);
//    }
//
//
...
//                        if (next.size() < max && doAcceptModeIndex(o.getMode())) {
//                            next.add(o);
//                        }
//                    }
//                }
...
//        return new Complex(sqr(n.m * PI / domain.xwidth()) + sqr(n.n * PI / domain.ywidth()) - sqr(cachedk0)*bs.getEpsr()).sqrt();
//    }
//
//
...
//                    nx,
//                    /**sin**/(m * PI / a), -(m * PI / a) * domain.xmin(),
//                    /**sin**/(n * PI / b), -(n * PI / b) * domain.ymin(),
//                    domain
//            ).setName("nx.sin(" + m + "PIx/a)sin(" + n + "PIx/b)").toDD();
//
//            DoubleToDouble fy = cosXcosY(
//                    ny,
//                    /**cos**/(m * PI / a), -(m * PI / a) * domain.xmin(),
//                    /**cos**/(n * PI / b), -(n * PI / b) * domain.ymin(),
//                    domain
