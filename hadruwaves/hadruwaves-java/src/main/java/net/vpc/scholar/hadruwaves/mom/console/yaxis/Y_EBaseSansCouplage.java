...
//
//public class Y_EBaseSansCouplage extends PlotElectricFieldAbstract implements Cloneable {
//    public Y_EBaseSansCouplage(Axis axis, YType...  type) {
//        super("EBaseSansCouplage"+ axis, axis,type);
//    }
//
//    protected Complex[][][] resolveE(MomStructure structure, double[] x, double[] y, double[] z0, ProgressMonitor monitor){
//        return structure.computeEBaseSansCouplage(x, y, z0,getAxis());
//    }
//}
