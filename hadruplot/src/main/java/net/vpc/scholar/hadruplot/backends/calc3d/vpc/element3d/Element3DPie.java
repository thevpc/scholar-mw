 ...
 * 
 */
public class Element3DPie extends Element3Db {

	/**
	 *
	 */
	private static final long serialVersionUID = 3060747132508766091L;
	private static Logger LOG = Logger.getLogger(Element3DPie.class.getName());
	...
	public Element3DPie(int objectCode) {
	...
	public Element3DPie(int objectCode, double a, double b, double c) {
		this.objectCode = objectCode;
		parameters[0]=a;
		parameters[1]=b;
		parameters[2]=c;
