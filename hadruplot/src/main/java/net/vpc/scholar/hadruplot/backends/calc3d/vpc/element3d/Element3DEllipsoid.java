package net.vpc.scholar.hadruplot.backends.calc3d.vpc.element3d;
 ...
 * 
 */
public class Element3DEllipsoid extends Element3Db {

	/**
	 *
	 */
	private static final long serialVersionUID = 3060747132508766091L;
	private static Logger LOG = Logger.getLogger(Element3DEllipsoid.class.getName());
	...
	public Element3DEllipsoid(int objectCode) {
	...
	public Element3DEllipsoid(int objectCode, double a, double b, double c) {
		this.objectCode = objectCode;
		parameters[0]=a;
		parameters[1]=b;
		parameters[2]=c;
