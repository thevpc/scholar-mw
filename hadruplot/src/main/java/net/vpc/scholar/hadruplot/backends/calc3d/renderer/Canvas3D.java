...
import net.vpc.scholar.hadruplot.backends.calc3d.anaglyph.AnaglyphFactory;
...
import net.vpc.scholar.hadruplot.backends.calc3d.geometry3d.Object3D;
import net.vpc.scholar.hadruplot.backends.calc3d.geometry3d.bsp.BSPTree;
import net.vpc.scholar.hadruplot.backends.calc3d.geometry3d.bsp.BSPTreeBuilder;
import net.vpc.scholar.hadruplot.backends.calc3d.geometry3d.bsp.BSPTreeTraverser;
...
public final class Canvas3D extends JPanel implements Printable 
{
	...
	public void setScene(Scene3D scene)
	{
		...
		for (Object3D<PrimitiveElement3D> obj : scene.object3Ds)
			for (PrimitiveElement3D e: obj.elements) primitiveElement3DS.add(e);
