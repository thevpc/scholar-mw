package net.vpc.scholar.hadruplot.backends.calc3d.math;

import java.io.Serializable;

import net.vpc.scholar.hadruplot.backends.calc3d.math.exceptions.NoninvertibleTransform3DException;
