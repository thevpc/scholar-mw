...
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3DCurve;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3DLine;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3DLineSegment;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3DParametricSurface;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3DPlane;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3DPoint;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3DSurface;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3DVector;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3DVectorField;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3Dcartesian2D;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3Dimplicit2D;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3DObject;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3DPolygon;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3Dfunction;
import net.thevpc.scholar.hadruplot.libraries.calc3d.elements.Element3DImplicit;
