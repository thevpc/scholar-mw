...
import net.thevpc.scholar.hadruplot.libraries.calc3d.renderer.Canvas3D;
import net.thevpc.scholar.hadruplot.libraries.calc3d.renderer.InteractionHandler;
import net.thevpc.scholar.hadruplot.libraries.calc3d.renderer.Renderer;
...
public class Calc3dTool {
     ...
     */
    private net.thevpc.scholar.hadruplot.libraries.calc3d.renderer.Renderer renderer;
    /**
    ...
    public Calc3dTool() {
        ...
        renderer = new net.thevpc.scholar.hadruplot.libraries.calc3d.renderer.Renderer(sceneManager.getSettings());
