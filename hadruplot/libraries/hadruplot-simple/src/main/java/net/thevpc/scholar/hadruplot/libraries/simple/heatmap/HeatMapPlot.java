...
//        }
        ...
        public StatusBarElement setAnyValue(Object d) {
            if (d == null) {
                setText("");
                d = "";
...
//        }
    ...
    private class StatusBar extends JPanel {
        StatusBarElement xLabel = new StatusBarElement("xLabel").setAnyValue("x");
        StatusBarElement yLabel = new StatusBarElement("yLabel").setAnyValue("y");
        StatusBarElement zLabel = new StatusBarElement("zLabel").setAnyValue("z");
