...
public class Preferences implements Serializable {
    ...
    private Box3D infiniteBox = new Box3D();
    ...
    private Paint backColor = Color.red;
...
//        splashScreenEnabled = true;
    ...
    public <T extends ExtraPrefs> T getExtra() {
        return (T) extra;
    }
...
//    }
    ...
    public void setClipBox(Box3D clipBox) {
        ...
        double maxX = clipBox.getMaxX();
        double minX = clipBox.getMinX();
        double maxY = clipBox.getMaxY();
        double minY = clipBox.getMinY();
        double maxZ = clipBox.getMaxZ();
        double minZ = clipBox.getMinZ();
        this.infiniteBox = new Box3D(
                minX-0.1*(maxX-minX), 
                maxX-0.1*(maxX-minX), 
                minY-0.1*(maxY-minY),  
                maxY-0.1*(maxY-minY), 
    ...
    public Box3D getInfiniteBox() {
        return infiniteBox;
    }

    public void setInfiniteBox(Box3D infiniteBox) {
        this.infiniteBox = infiniteBox;
    }
    ...
    public Preferences setExtra(ExtraPrefs extra) {
        this.extra = extra;
        return this;
    }
