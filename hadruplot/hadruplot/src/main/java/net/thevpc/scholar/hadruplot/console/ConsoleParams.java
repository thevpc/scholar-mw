...
import net.thevpc.scholar.hadruplot.console.params.ArrayParamSet;
import net.thevpc.scholar.hadruplot.console.params.BooleanArrayParamSet;
import net.thevpc.scholar.hadruplot.console.params.CParam;
import net.thevpc.scholar.hadruplot.console.params.DoubleArrayParamSet;
import net.thevpc.scholar.hadruplot.console.params.FloatArrayParamSet;
import net.thevpc.scholar.hadruplot.console.params.IntArrayParamSet;
import net.thevpc.scholar.hadruplot.console.params.LongArrayParamSet;
