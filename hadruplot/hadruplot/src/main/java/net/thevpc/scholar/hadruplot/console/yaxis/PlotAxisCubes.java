...
//        x2values = getY(direct, modele, x_axis);
    ...
    public PlotHyperCube[] eval(ConsoleActionParams p) {
        ...
        ProgressMonitor[] monitors = ProgressMonitors.split(this, new double[]{
                        _b_referenceMatrix?10:0,
                        _b_modeledMatrix?10:0,
                        _b_relativeError?1:0,
                        _b_absoluteError?1:0});
...
//            }
    ...
    protected abstract PlotHyperCube evalValue(ConsoleAwareObject structure, net.thevpc.common.mon.ProgressMonitor monitor, ConsoleActionParams p);
