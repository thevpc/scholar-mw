...
//    }
//
    public Mesh3DPlot(PlotModelProvider modelProvider, ColorPalette colorPalette) {
        this((ValuesPlotModel) modelProvider.getModel(), colorPalette);
    }

    public Mesh3DPlot(ValuesPlotModel model, ColorPalette colorPalette) {
        this(new ValuesPlotXYDoubleModelFace(model, null), colorPalette, null);
    }

    public Mesh3DPlot(ValuesPlotXYDoubleModelFace model, ColorPalette colorPalette, PlotModelProvider plotModelProvider) {
