...
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3DCurve;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3DLine;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3DLineSegment;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3DParametricSurface;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3DPlane;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3DPoint;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3DSurface;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3DVector;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3DVectorField;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3Dcartesian2D;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3Dimplicit2D;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3DObject;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3DPolygon;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3Dfunction;
import net.vpc.scholar.hadruplot.libraries.calc3d.elements.Element3DImplicit;
