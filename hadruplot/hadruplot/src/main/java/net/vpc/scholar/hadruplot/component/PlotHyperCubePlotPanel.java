package net.vpc.scholar.hadruplot.component;
...
import net.vpc.scholar.hadruplot.libraries.simple.heatmap.DefaultPlotNormalizer;
...
import net.vpc.scholar.hadruplot.BasePlotComponent;
import net.vpc.scholar.hadruplot.DefaultPlotComponentContext;
import net.vpc.scholar.hadruplot.LibraryPlotType;
import net.vpc.scholar.hadruplot.PlotBackendLibraries;
...
public class PlotHyperCubePlotPanel extends BasePlotComponent implements PlotPanel {
    ...
    private ToDoubleFunction<Object> convert = PlotDoubleConverter.ABS;
                ...
                case FULL: {
                    for (PlotHyperCube c3D : model2.getHyperCubes()) {
                        ...
                        for (int i = 0; i < d; i++) {
                            ...
                            ToDoubleFunction<Object> dc = convert;
                            if (dc == null) {
