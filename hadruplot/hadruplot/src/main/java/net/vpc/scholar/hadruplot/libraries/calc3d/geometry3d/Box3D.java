...
public class Box3D implements Serializable {
    ...
    public Box3D(double x0, double x1, double y0, double y1, double z0,
        ...
        if (Double.isInfinite(xmin)
                ...
                || Double.isInfinite(zmin)
                || Double.isInfinite(zmax)) {
            System.err.println("Infinite Clip");
        }
    ...
    /**
     * Returns the Box3D which is contained both by this box and by the
     * specified box.
     *
     * @param box the bounding box to include
     * @return this
    ...
    public void transform(AffineTransform3D _globalTrans) {
    ...
    public boolean equals(Object obj) {
        ...
        Box3D b = (Box3D) obj;
        if ((b.xmin == xmin) && (b.xmax == xmax) && (b.ymin == ymin) && (b.ymax == ymax) && (b.zmin == zmin) && (b.zmax == zmax)) {
            return true;
        } else {
            return false;
        }
