 ...
 */
public class ColorPalette2 extends ColorPalette implements Cloneable{
     ...
     */
    public ColorPalette2(String name, boolean reverse) {
     ...
     */
    public ColorPalette2(String name, int colorType, boolean reverse) {
        super(name,reverse);
    ...
    ColorPalette2(String name, int colorType, boolean mirrored, ArrayList<Double> divisionPoints, ArrayList<float[]> colorComponents, boolean reverse) {
        super(name,reverse);
    ...
    public static ColorPalette2 makeDefaultPalette(String paletteName) {
     ...
     */
    public static ColorPalette2 makeDefaultPalette(String paletteName, boolean reverse) {
        ColorPalette2 palette;
        if (paletteName.equals("Spectrum")) {
            palette = new ColorPalette2("Spectrum",reverse);
        }
        else if (paletteName.equals("PaleSpectrum")) {
            palette = new ColorPalette2("PaleSpectrum",reverse);
            ...
            palette = new ColorPalette2("DarkSpectrum",reverse);
            ...
            palette =new ColorPalette2("Grayscale", ColorPalette2.COLOR_TYPE_RGB,reverse);
        }
        else if (paletteName.equals("CyclicGrayscale")) {
            palette = new ColorPalette2("CyclicGrayscale", ColorPalette2.COLOR_TYPE_RGB,reverse);
            palette.split(0.5);
            ...
            palette = new ColorPalette2("CyclicRedCyan", ColorPalette2.COLOR_TYPE_RGB,reverse);
            palette.split(0.5);
            ...
            palette = new ColorPalette2("EarthSky", ColorPalette2.COLOR_TYPE_RGB,reverse);
            palette.split(0.15);
            palette.split(0.33);
            palette.split(0.67);
            palette.split(0.85);
            ...
            palette = new ColorPalette2("HotCold", ColorPalette2.COLOR_TYPE_RGB,reverse);
            palette.split(0.16);
            palette.split(0.5);
            palette.split(0.84);
            palette.setDivisionPointColorComponents(0, 1, 1, 1);
            ...
            palette = new ColorPalette2("Fire", ColorPalette2.COLOR_TYPE_RGB,reverse);
            palette.split(0.17);
            palette.split(0.83);
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof ColorPalette2))
            return false;
        ColorPalette2 that = (ColorPalette2)obj;
    ...
    public ColorPalette2 clone() {
        ColorPalette2 that = new ColorPalette2(getName(),this.colorType,isReverse());
     ...
     */
    public void copyFrom(ColorPalette2 that) {
