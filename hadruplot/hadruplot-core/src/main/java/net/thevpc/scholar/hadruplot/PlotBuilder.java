...
//    }
    ...
    public PlotBuilder domain(Object domain) {
        this.domain = PlotConfigManager.getPlotDomainResolvers().resolve(domain);
        return this;
    }
    ...
    public PlotBuilder windowManager(String windowManager) {
        this.windowManager = PlotWindowManagerFactory.create(windowManager);
        return this;
    }

    public PlotBuilder samples(Object samples0) {
        PlotSamples samples = PlotConfigManager.getPlotSamplesResolvers().resolve(samples0);
...
//    }
    ...
    public PlotBuilder xsamples(Object xvalue) {
        ...
        throw new IllegalArgumentException("Unsupported xsamples type : " + (xvalue == null ? null : xvalue.getClass().getSimpleName()));
    }
    ...
    public PlotBuilder ysamples(Object xvalue) {
        ...
        throw new IllegalArgumentException("Unsupported ysamples type : " + (xvalue == null ? null : xvalue.getClass().getSimpleName()));
    }
    ...
    public PlotBuilder zsamples(Object xvalue) {
        ...
        throw new IllegalArgumentException("Unsupported zsamples type : " + (xvalue == null ? null : xvalue.getClass().getSimpleName()));
    }

    public PlotBuilder xsamples(double[] xvalue) {
        if (samples instanceof AbsolutePlotSamples) {
            AbsolutePlotSamples a = (AbsolutePlotSamples) samples;
            switch (samples.getDimension()) {
                case 1: {
                    samples = PlotSamples.absolute(xvalue);
                    break;
                }
                case 2: {
                    samples = PlotSamples.absolute(xvalue, a.getY());
                    break;
                }
                case 3: {
                    samples = PlotSamples.absolute(xvalue, a.getY(), a.getZ());
                    break;
                }
            }
        } else {
    ...
    public PlotBuilder ysamples(double[] yvalue) {
        if (samples instanceof AbsolutePlotSamples) {
            ...
            switch (samples.getDimension()) {
                case 1: {
                    samples = PlotSamples.absolute(a.getX(), yvalue);
                    break;
                }
                case 2: {
                    samples = PlotSamples.absolute(a.getX(), yvalue);
                ...
                case 3: {
                    samples = PlotSamples.absolute(a.getX(), yvalue, a.getZ());
                    break;
                }
            }
        } else {
            samples = PlotSamples.absolute(yvalue, yvalue);
        }
        return this;
    }
    ...
    public PlotBuilder zsamples(double[] zvalue) {
        if (samples instanceof AbsolutePlotSamples) {
            ...
            switch (samples.getDimension()) {
                case 1: {
                    samples = PlotSamples.absolute(a.getX(), a.getY(), zvalue);
                    break;
                }
                case 2: {
                    samples = PlotSamples.absolute(a.getX(), a.getY(), zvalue);
            ...
            samples = PlotSamples.absolute(zvalue, zvalue, zvalue);
        }
        return this;
    }
    ...
    public PlotBuilder converter(ToDoubleFunction<Object> converter) {
    ...
    public PlotBuilder polarAngleOffset(double value) {
        plotViewConfig().polarAngleOffset.set(Math.toDegrees(value));
        return this;
    }

    public PlotBuilder polarAngleOffsetDegree(double value) {
        plotViewConfig().polarAngleOffset.set(value);
        return this;
    }

    private PlotViewConfig plotViewConfig() {
        Object c = properties.get("config");
        PlotViewConfig cc = null;
        if (c instanceof PlotViewConfig) {
            cc = (PlotViewConfig) c;
            return cc;
        } else {
            cc = new PlotViewConfig();
            param("config", cc);
            return cc;
        }
    }
...
//    }
    ...
    public PlotModel createPlotModel(Object any) {
        ...
        for (PlotValue plotValue : plottableData) {
            for (PlotModelFactory plotFactory : PlotConfigManager.getPlotModelFactories()) {
                PlotModel m = plotFactory.createModel(plotValue, this);
                if (m != null) {
                    return m;
                }
            }
    ...
    public ToDoubleFunction<Object> getConverter(ToDoubleFunction<Object> converter) {
    ...
    public PlotBuilder ui() {
        PlotUIManager.apply(null);
        return this;
    }

    public PlotBuilder ui(String id) {
        PlotUIManager.apply(id);
        return this;
    }
