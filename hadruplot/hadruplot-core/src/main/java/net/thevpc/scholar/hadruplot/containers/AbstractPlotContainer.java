...
public abstract class AbstractPlotContainer implements PlotContainer {
    ...
    public int indexOfPlotComponent(String name) {
        PlotContainerName pcn=new PlotContainerName(name);
...
//            }
    ...
    public PlotWindowContainerFactory getPlotWindowContainerFactory(String type) {
        if (type == null) {
            PlotWindowContainerFactory e = plotWindowContainerFactory;
            if (e != null) {
                return e;
            }
        }
        return PlotWindowContainerFactories.create(type);
    }
    ...
    public PlotContainer add(String name) {
        PlotContainerName pn = new PlotContainerName(name);
        PlotContainer container = getPlotWindowContainerFactory(pn.getType()).create();
        container.setPlotTitle(pn.getTitle());
...
//            c.getParent().setVisible(true);
    ...
    public PlotContainer add(final int index, String containerName) {
        PlotContainerName pn = new PlotContainerName(containerName);
        final PlotContainer container = getPlotWindowContainerFactory(pn.getType()).create();
        container.setPlotTitle(pn.getTitle());
        container.setPlotWindowManager(plotWindowManager);
