...
import net.thevpc.scholar.hadruplot.extension.defaults.DefaultValuesPlotModelPopupFactory;
...
public class PlotConfigManager {
    ...
    public static net.thevpc.scholar.hadruplot.console.PlotConfig Config = new PlotConfig() {
        @Override
