...
import net.thevpc.scholar.hadruplot.DefaultPlotComponentContext;
import net.thevpc.scholar.hadruplot.LibraryPlotType;
import net.thevpc.scholar.hadruplot.PlotBackendLibraries;
...
//        }
    ...
    public JFrame getFrame() {
        if (frame == null) {
            ...
            frame.setIconImage(new ImageIcon(getClass().getResource("/net/thevpc/scholar/hadruplot/icon.png")).getImage());
            frame.pack();
        }
        return frame;
    }
