...
//            }
        ...
        if (rv instanceof Minus) {
            return RewriteResult.newVal(Minus.of(Maths.real(rv.getChild(0)), Maths.real(rv.getChild(1))));
        }
    ...
    public static DoubleToDouble[] getMulRealImag(Mul m) {
        ...
        if (someReal == 0 && someImag == 0) {
            ...
            return new DoubleToDouble[]{Maths.prod(real).toDD(), Maths.DZEROXY};
        } else if (someReal == 0 && someImag != 0) {
            switch (someImag % 4) {
                case 0: {
                    return new DoubleToDouble[]{Maths.prod(imag).toDD(), Maths.DZEROXY};
                }
                case 1: {
                    return new DoubleToDouble[]{Maths.DZEROXY, Maths.prod(imag).toDD()};
                }
                case 2: {
                    return new DoubleToDouble[]{Neg.of(Maths.prod(imag).toDD()).toDD(), Maths.DZEROXY};
                }
                case 3: {
                    return new DoubleToDouble[]{Maths.DZEROXY, Neg.of(Maths.prod(imag).toDD()).toDD()};
                }
            }
            ...
            if (others.size() == 1) {
                if (realOnly.isEmpty()) {
                    ...
                    return new DoubleToDouble[]{
                            r.length == 1 ? r[0].toDD() : Maths.prod(r).toDD(),
                            i.length == 1 ? i[0].toDD() : Maths.prod(i).toDD()
                    };
                }
            } else {
                DoubleToComplex a = e;
                ...
                if (others.size() == 2) {
                    ...
                    e2.remove(0);
                    b = Maths.prod(e2.toArray(new Expr[0])).toDC();
                }
                Minus realFull = Minus.of(Maths.mul(a.getRealDD(), b.getRealDD()), Maths.mul(a.getImagDD(), b.getImagDD()));
