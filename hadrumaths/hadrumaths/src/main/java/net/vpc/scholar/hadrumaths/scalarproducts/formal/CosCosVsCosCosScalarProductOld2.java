...
final class CosCosVsCosCosScalarProductOld2 implements FormalScalarProductHelper {
    ...
    private static double primi_cos4_af_fc(Domain domain, CosXCosY f, CosXCosY g) {
        ...
        if (fa == 0 && fc == 0 && ga == 0 && gc == 0) {
            ...
            x = b1;
            y = b3;
            value = (famp * cos2(fd) * gamp * cos2(gd) * (0.25 / fa * sin2(2.0 * fa * x + fb - gb) + 0.5 * cos2(fb + gb) * x) * y);
            x = b2;
            y = b4;
            value += (famp * cos2(fd) * gamp * cos2(gd) * (0.25 / fa * sin2(2.0 * fa * x + fb - gb) + 0.5 * cos2(fb + gb) * x) * y);
            x = b1;
            ...
            x = b1;
            y = b3;
            value = (famp * gamp * (0.25 / fa * sin2(2.0 * fa * x + fb - gb) + 0.5 * cos2(fb + gb) * x) * (0.5 * cos2(fd - gd) * y + 0.25 / fc * sin2(2.0 * fc * y + fd + gd)));
            x = b2;
            y = b4;
            value += (famp * gamp * (0.25 / fa * sin2(2.0 * fa * x + fb - gb) + 0.5 * cos2(fb + gb) * x) * (0.5 * cos2(fd - gd) * y + 0.25 / fc * sin2(2.0 * fc * y + fd + gd)));
            x = b1;
    ...
    private static double primi_cos4_af_fgc(Domain domain, CosXCosY f, CosXCosY g) {
        ...
        if (fa == 0 && fc == 0 && ga == 0 && gc == 0) {
            ...
            x = b1;
            y = b3;
            value = (famp * gamp * cos2(gd) * (0.25 / fa * sin2(2.0 * fa * x + fb - gb) + 0.5 * cos2(fb + gb) * x) / fc * sin2(fc * y + fd));
            x = b2;
            y = b4;
            value += (famp * gamp * cos2(gd) * (0.25 / fa * sin2(2.0 * fa * x + fb - gb) + 0.5 * cos2(fb + gb) * x) / fc * sin2(fc * y + fd));
            x = b1;
            ...
            x = b1;
            y = b3;
            value = (famp * cos2(fd) * gamp * (0.25 / fa * sin2(2.0 * fa * x + fb - gb) + 0.5 * cos2(fb + gb) * x) / gc * sin2(gc * y + gd));
            x = b2;
            y = b4;
            value += (famp * cos2(fd) * gamp * (0.25 / fa * sin2(2.0 * fa * x + fb - gb) + 0.5 * cos2(fb + gb) * x) / gc * sin2(gc * y + gd));
            x = b1;
            ...
            x = b1;
            y = b3;
            value = (famp * gamp * (0.25 / fa * sin2(2.0 * fa * x + fb - gb) + 0.5 * cos2(fb + gb) * x) * (0.5 / (fc - gc) * sin2((fc - gc) * y + fd - gd) + 0.5 / (fc + gc) * sin2((fc + gc) * y + fd + gd)));
            x = b2;
            y = b4;
            value += (famp * gamp * (0.25 / fa * sin2(2.0 * fa * x + fb - gb) + 0.5 * cos2(fb + gb) * x) * (0.5 / (fc - gc) * sin2((fc - gc) * y + fd - gd) + 0.5 / (fc + gc) * sin2((fc + gc) * y + fd + gd)));
            x = b1;
    ...
    private static double primi_cos4_fga_fc(Domain domain, CosXCosY f, CosXCosY g) {
        ...
        } else if (fa == 0 && fc == 0 && ga != 0 && gc == 0) {//famp*cos2(fb)*cos2(fd)*cos2(ga*x+gb)*cos2(gd)
            x = b1;
            y = b3;
