...
public class DefaultComplexValue implements DoubleToComplex, ComplexValue {
    ...
    public String toLatex() {
        return value.toLatex()+"*"+getDomain().toLatex();
    }
...
//    }
    ...
    public Expr plus(Expr other) {
        switch (other.getType()){
            case DOUBLE_NBR:return plus(other.toDouble());
            case COMPLEX_NBR:return plus(other.toComplex());
        }
        return ExprDefaults.add(value,other);
    }

    public DefaultComplexValue plus(Complex other) {
        return DefaultComplexValue.of(value.plus(other), domain);
    }
    ...
    public DefaultComplexValue sub(Complex other) {
        return DefaultComplexValue.of(value.minus(other), domain);
    }
...
//    }
    ...
    public DoubleToComplex plus(DoubleToComplex other) {
