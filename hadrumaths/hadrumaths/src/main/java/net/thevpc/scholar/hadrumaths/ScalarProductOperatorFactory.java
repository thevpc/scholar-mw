...
import net.thevpc.scholar.hadrumaths.integration.DRectLowIntegralXY;
import net.thevpc.scholar.hadrumaths.integration.DRectMidIntegralXY;
...
import net.thevpc.scholar.hadrumaths.scalarproducts.numeric.SimpleNumericScalarProductOperator;
