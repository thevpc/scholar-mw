...
//    public double eval(DomainXY domain, DFunctionXY f1, DFunctionXY f2, FormalScalarProduct sp) {
...
//    }
    ...
    private static double eval(Domain domain, double f_amp, double f_a, double f_b, double f_c, double f_d, double g_amp, double g_a, double g_b, double g_c, double g_d) {
        if (f_a == g_a && f_c == g_c) {
    ...
    private static double evalTolerant(Domain domain, double f_amp, double f_a, double f_b, double f_c, double f_d, double g_amp, double g_a, double g_b, double g_c, double g_d, double tolerance) {
