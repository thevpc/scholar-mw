...
// */
//public class Surface extends AbstractHGeometry implements Cloneable {
...
//
//    public Surface(HGeometry other) {
//        this(other.getPath());
//    }
//
...
//            List<HPoint> points2 = new ArrayList<HPoint>();
//            for (int i = 0; i < xs.size(); i++) {
//                double xx = xs.get(i);
//                double yy = ys.get(i);
//                HPoint e = new HPoint(xx, yy);
//                points2.add(e);
//                xm.add(xx);
//                ym.add(yy);
//            }
...
//    }
//
//    private void _add(List<HPoint> points,
//                      List<Double> xs,
...
//            }
//        }
//        HPoint p = HPoint.create(coords[pos], coords[pos + 1]);
//        xs.add(coords[pos]);
//        ys.add(coords[pos + 1]);
//        points.add(p);
//        old[0] = coords[pos];
...
//        if (isPolygonal()) {
//            return GeometryFactory.createPolygon(points.toArray(new HPoint[0]));
//        }
...
//        if (isTriangular()) {
//            return new DefaultHTriangle(points.get(0), points.get(1), points.get(2));
//        }
...
//    }
//
//    public Surface intersectGeometry(HGeometry geometry) {
//
...
//    }
//
//    public Surface subtractGeometry(HGeometry geometry) {
//        Surface other = geometry.toSurface();
//        Domain d1 = this.domain;
//        Domain d2 = other.domain;
//        Domain d = d1.expand(d2);
...
//    }
//
//    public Surface addGeometry(HGeometry geometry) {
//        Surface other = geometry.toSurface();
//        Domain d1 = this.domain;
//        Domain d2 = other.domain;
//        Domain d = d1.expand(d2);
...
//    }
//
//    public Surface exclusiveOrGeometry(HGeometry geometry) {
//        Surface other = geometry.toSurface();
//        Domain d1 = this.domain;
//        Domain d2 = other.domain;
//        Domain d = d1.expand(d2);
...
//    }
//
//    public Surface addGeometry_(HGeometry geometry) {
//        Surface other = geometry.toSurface();
//        Domain d1 = this.domain;
//        Domain d2 = other.domain;
//        Domain d = d1.expand(d2);
