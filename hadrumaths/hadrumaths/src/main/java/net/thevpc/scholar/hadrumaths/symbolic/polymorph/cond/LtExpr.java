 ...
 */
public class LtExpr extends AbstractComparatorExpr {
    private static final long serialVersionUID = 1L;

    private LtExpr(DoubleToDouble xarg, DoubleToDouble yarg) {
        super(xarg, yarg, xarg.getDomain().intersect(yarg.getDomain()));
    }

    @Override
    public NElement toElement() {
        return NElement.ofNamedObject("LtExpr");
    }
    ...
    public Expr newInstance(Expr[] xarguments) {
        return LtExpr.of(xarguments[0].toDD(), xarguments[1].toDD());
    }

    public static LtExpr of(DoubleToDouble a, DoubleToDouble b) {
        return new LtExpr(a.toDD(), b.toDD());
    }
