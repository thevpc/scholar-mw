...
public final class ExpressionManagerFactory {
    ...
    public static Jeep createParser0() {
        ...
        e.operators().declareBinaryOperator("**",JOperatorPrecedences.PRECEDENCE_1+1);
        e.operators().declarePrefixUnaryOperators("-", "!", "~");
        e.operators().declareListOperator(",", JOperatorPrecedences.PRECEDENCE_1);
        ...
        e.functions().declare("{", new JType[]{Expr_type}, Vector_type, false, new JInvoke() {
            ...
            public Object invoke(JInvokeContext context) {
                JEvaluable[] args = context.getArguments();
    ...
    private static class MathsParserUtilClassJResolver extends UtilClassJResolver {
        ...
        public JFunction createMethodInvocationFunction(String name, JMethod m, int baseIndex, int... argIndices) {
            switch (m.toString()) {
                case "public static net.thevpc.scholar.hadrumaths.Expr net.thevpc.scholar.hadrumaths.expeval.PlatformHelperAsExpr.domain(net.thevpc.scholar.hadrumaths.RightArrowUplet2)": {
                    return new JMethodInvocationFunction(name, m, baseIndex, argIndices) {
                        @Override
                        protected Object evaluateImpl(JMethod m, JInvokeContext icontext) {
...
//                            }
                ...
                case "public static net.thevpc.scholar.hadrumaths.Expr net.thevpc.scholar.hadrumaths.expeval.PlatformHelperAsExpr.domain(net.thevpc.scholar.hadrumaths.RightArrowUplet2,net.thevpc.scholar.hadrumaths.RightArrowUplet2)": {
                    return new JMethodInvocationFunction(name, m, baseIndex, argIndices) {
                        @Override
                        protected Object evaluateImpl(JMethod m, JInvokeContext icontext) {
                            RightArrowUplet2 a = (RightArrowUplet2) icontext.evaluateArg(0);
...
//                            }
                ...
                case "public static net.thevpc.scholar.hadrumaths.Expr net.thevpc.scholar.hadrumaths.expeval.PlatformHelperAsExpr.domain(net.thevpc.scholar.hadrumaths.RightArrowUplet2,net.thevpc.scholar.hadrumaths.RightArrowUplet2,net.thevpc.scholar.hadrumaths.RightArrowUplet2)": {
                    return new JMethodInvocationFunction(name, m, baseIndex, argIndices) {
                        @Override
