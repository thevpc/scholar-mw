 ...
 */
public final class MemRawD1ComplexMatrix extends AbstractComplexMatrix implements Serializable {
    ...
    private MemRawD1ComplexMatrix(int rows, int cols, double[] reals, double[] imags) {
        this.rowsCount = rows;
    ...
    MemRawD1ComplexMatrix(int rows, int cols) {
        if (rows == 0 || cols == 0) {
    ...
    public ComplexMatrix getMatrix(int[] r, int c1, int c2) {
        MemRawD1ComplexMatrix X = new MemRawD1ComplexMatrix(r.length, c2 - c1 + 1);
        double[] Br = X.reals;
        double[] Bi = X.imags;
        try {
    ...
    public ComplexMatrix div(double c) {
        ...
        return new MemRawD1ComplexMatrix(rowsCount, columnsCount, r2, i2);
    }
    ...
    public ComplexMatrix div(Complex c) {
        ...
        return new MemRawD1ComplexMatrix(rowsCount, columnsCount, er, ei);
    }
...
//            }
    ...
    public MemRawD1ComplexMatrix coMatrix(int row, int col) {
        int tms = getRowCount();
        MemRawD1ComplexMatrix ap = (MemRawD1ComplexMatrix) createMatrix(tms - 1, tms - 1);
        int ia = 0;
        int ja;
