...
//package net.thevpc.scholar.math.functions.cfxy;
//
...
//import net.thevpc.scholar.math.functions.dfxy.DxySum;
//
///**
// * Class Description
// *
...
////        return isZero()?FunctionFactory.CZEROXY: new DefaultDoubleToComplex(this.imag.simplify(), this.real.simplify());
////    }
