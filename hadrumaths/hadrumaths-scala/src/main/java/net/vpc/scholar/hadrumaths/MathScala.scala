...
import net.vpc.scholar.hadrumaths.symbolic.double2double.{AxisFunction, DoubleParam}
...
object MathScala {
  ...
  implicit def convertImplicitRightArrowUplet2Double(x: scala.Tuple2[Double, Double]): net.vpc.scholar.hadrumaths.RightArrowUplet2.Double = {
...
//  }
  ...
  def I(iValue: Array[Array[Complex]]): ComplexMatrix = {
    //    matrix(iValue).mul(I)
    matrix(iValue).mul(net.vpc.scholar.hadrumaths.Complex.of(0, 1))
    //TODO
    //    return null;
    //   Maths.I(iValue)
  }
  ...
  def I(dValue: Double): Complex = {
    //    Maths.I(dValue)
    net.vpc.scholar.hadrumaths.Complex.of(0, dValue)
    //TODO
    //    return null;
  }
