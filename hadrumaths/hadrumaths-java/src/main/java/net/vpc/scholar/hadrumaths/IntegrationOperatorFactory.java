...
//    }
    ...
    public static IntegrationOperator quad() {
        return new FormalIntegrationOperator((FormalScalarProductOperator) ScalarProductOperatorFactory.quad());
    }

    public static IntegrationOperator quad(double tolerance, double minWindow, double maxWindow, int maxfcnt) {
        return new FormalIntegrationOperator((FormalScalarProductOperator) ScalarProductOperatorFactory.quad(tolerance, minWindow, maxWindow, maxfcnt));
    }
    ...
    public static IntegrationOperator rectlow() {
        return new FormalIntegrationOperator((FormalScalarProductOperator) ScalarProductOperatorFactory.rectlow());
    }
