 ...
 */
public class JColorPalette2 extends JColorPalette implements Cloneable{
     ...
     */
    public JColorPalette2(String name,boolean reverse) {
        this(name,COLOR_TYPE_HSB,reverse);
    }
     ...
     */
    public JColorPalette2(String name,int colorType,boolean reverse) {
        super(name,reverse);
    ...
    JColorPalette2(String name,int colorType, boolean mirrored, ArrayList<Double> divisionPoints, ArrayList<float[]> colorComponents,boolean reverse) {
        super(name,reverse);
    ...
    public static JColorPalette2 makeDefaultPalette(String paletteName) {
        return makeDefaultPalette(paletteName,false);
    }
     ...
     */
    public static JColorPalette2 makeDefaultPalette(String paletteName,boolean reverse) {
        JColorPalette2 palette;
        if (paletteName.equals("Spectrum")) {
            palette = new JColorPalette2("Spectrum",reverse);
        }
        else if (paletteName.equals("PaleSpectrum")) {
            palette = new JColorPalette2("PaleSpectrum",reverse);
            ...
            palette = new JColorPalette2("DarkSpectrum",reverse);
            ...
            palette =new JColorPalette2("Grayscale",JColorPalette2.COLOR_TYPE_RGB,reverse);
        }
        else if (paletteName.equals("CyclicGrayscale")) {
            palette = new JColorPalette2("CyclicGrayscale",JColorPalette2.COLOR_TYPE_RGB,reverse);
            palette.split(0.5);
            ...
            palette = new JColorPalette2("CyclicRedCyan",JColorPalette2.COLOR_TYPE_RGB,reverse);
            palette.split(0.5);
            ...
            palette = new JColorPalette2("EarthSky",JColorPalette2.COLOR_TYPE_RGB,reverse);
            palette.split(0.15);
            palette.split(0.33);
            palette.split(0.67);
            palette.split(0.85);
            ...
            palette = new JColorPalette2("HotCold",JColorPalette2.COLOR_TYPE_RGB,reverse);
            palette.split(0.16);
            palette.split(0.5);
            palette.split(0.84);
            palette.setDivisionPointColorComponents(0, 1, 1, 1);
            ...
            palette = new JColorPalette2("Fire",JColorPalette2.COLOR_TYPE_RGB,reverse);
            palette.split(0.17);
            palette.split(0.83);
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof JColorPalette2))
            return false;
        JColorPalette2 that = (JColorPalette2)obj;
    ...
    public JColorPalette2 clone() {
        JColorPalette2 that = new JColorPalette2(getName(),this.colorType,isReverse());
     ...
     */
    public void copyFrom(JColorPalette2 that) {
        this.setReverse(that.isReverse());
     ...
     */
    public Color getColorImpl(float position) {
