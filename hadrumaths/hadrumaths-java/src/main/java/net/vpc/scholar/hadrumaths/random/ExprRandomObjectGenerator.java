...
import net.vpc.common.util.AcceptDenyEnumSet;
...
import net.vpc.scholar.hadrumaths.symbolic.complex2complex.DefaultCustomCCFunctionXExpr;
...
import net.vpc.scholar.hadrumaths.symbolic.double2complex.*;
...
//        denyType(.class);
        ...
        register(Expr.class, new Generator() {
            ...
            public Object generate(Class cls, Class asType, RandomObjectGeneratorContext context) {
                ...
                if (cls.equals(Expr.class)) {
                    Class[] exprClasses = Stream.of(findObjectClasses())
                            .filter(x -> context.getClsTypes().isAccept(x)).toArray(Class[]::new);
        ...
        for (Class twoArgsFunction : new Class[]{Div.class, Pow.class, Reminder.class, Sub.class
        }) {
        ...
        register(Plus.class, new Generator() {
            ...
            public Object generate(Class cls, Class asType, RandomObjectGeneratorContext context) {
                ...
                if (aClass.equals(DoubleToVector.class)) {
                    ...
                    Expr b = a.mul(2).add(Maths.X);
                    return Maths.add(a, b);
                }
                if (aClass.equals(DoubleToMatrix.class)) {
                    Expr a = (Expr) randomObject(aClass, aClass, context.decComplexity());
                    Expr b = DefaultDoubleToMatrix.of(a.toDM()).mul(2).add(Maths.X);
                    return Maths.add(a, b);
                }
                Expr a = (Expr) randomObject(aClass, aClass, context.decComplexity());
        ...
        register(Polygon.class, new Generator() {
                    @Override
                    public Object generate(Class cls, Class asType, RandomObjectGeneratorContext context) {
                        return new Polygon(new Point(0, 0), new Point(1, 0), new Point(1, 1));
                    }
                }
        );
        ...
        if (context.getComplexity() <= 0) {
            if (Expr.class.isAssignableFrom(cls)
                ...
                if (cls.equals(Sub.class)) {
                    return (T) Sub.of(Maths.TWO, Maths.ONE);
                }
