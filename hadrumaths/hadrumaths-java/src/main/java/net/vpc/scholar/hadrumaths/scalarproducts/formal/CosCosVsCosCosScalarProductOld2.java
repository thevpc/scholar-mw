 ...
 * Time: 15:13:30
 */
final class CosCosVsCosCosScalarProductOld2 implements FormalScalarProductHelper {
    @Override
    public int hashCode() {
    ...
    private static double primi_cos4_fga_fc(Domain domain, CosXCosY f, CosXCosY g) {
        ...
        } else if (f.a == 0 && f.c == 0 && g.a != 0 && g.c == 0) {//f.amp*cos2(f.b)*cos2(f.d)*cos2(g.a*x+g.b)*cos2(g.d)
            x = b1;
            y = b3;
            value = (f.amp * cos2(f.b) * cos2(f.d) * g.amp * cos2(g.d) / g.a * sin2(g.a * x + g.b) * y);
            x = b2;
    ...
    private static double primi_cos4_af_fgc(Domain domain, CosXCosY f, CosXCosY g) {
        ...
        if (f.a == 0 && f.c == 0 && g.a == 0 && g.c == 0) {
            ...
            x = b1;
            y = b3;
            value = (f.amp * cos2(f.d) * g.amp * cos2(g.d) * (0.25 / f.a * sin2(2.0 * f.a * x + f.b - g.b) + 0.5 * cos2(f.b + g.b) * x) * y);
            x = b2;
            y = b4;
            value += (f.amp * cos2(f.d) * g.amp * cos2(g.d) * (0.25 / f.a * sin2(2.0 * f.a * x + f.b - g.b) + 0.5 * cos2(f.b + g.b) * x) * y);
            x = b1;
            ...
            x = b1;
            y = b3;
            value = (f.amp * g.amp * cos2(g.d) * (0.25 / f.a * sin2(2.0 * f.a * x + f.b - g.b) + 0.5 * cos2(f.b + g.b) * x) / f.c * sin2(f.c * y + f.d));
            x = b2;
            y = b4;
            value += (f.amp * g.amp * cos2(g.d) * (0.25 / f.a * sin2(2.0 * f.a * x + f.b - g.b) + 0.5 * cos2(f.b + g.b) * x) / f.c * sin2(f.c * y + f.d));
            x = b1;
            ...
            x = b1;
            y = b3;
            value = (f.amp * cos2(f.d) * g.amp * (0.25 / f.a * sin2(2.0 * f.a * x + f.b - g.b) + 0.5 * cos2(f.b + g.b) * x) / g.c * sin2(g.c * y + g.d));
            x = b2;
            y = b4;
            value += (f.amp * cos2(f.d) * g.amp * (0.25 / f.a * sin2(2.0 * f.a * x + f.b - g.b) + 0.5 * cos2(f.b + g.b) * x) / g.c * sin2(g.c * y + g.d));
            x = b1;
            ...
            x = b1;
            y = b3;
            value = (f.amp * g.amp * (0.25 / f.a * sin2(2.0 * f.a * x + f.b - g.b) + 0.5 * cos2(f.b + g.b) * x) * (0.5 / (f.c - g.c) * sin2((f.c - g.c) * y + f.d - g.d) + 0.5 / (f.c + g.c) * sin2((f.c + g.c) * y + f.d + g.d)));
            x = b2;
            y = b4;
            value += (f.amp * g.amp * (0.25 / f.a * sin2(2.0 * f.a * x + f.b - g.b) + 0.5 * cos2(f.b + g.b) * x) * (0.5 / (f.c - g.c) * sin2((f.c - g.c) * y + f.d - g.d) + 0.5 / (f.c + g.c) * sin2((f.c + g.c) * y + f.d + g.d)));
            x = b1;
    ...
    private static double primi_cos4_af_fc(Domain domain, CosXCosY f, CosXCosY g) {
        ...
        if (f.a == 0 && f.c == 0 && g.a == 0 && g.c == 0) {
            ...
            x = b1;
            y = b3;
            value = (f.amp * g.amp * (0.25 / f.a * sin2(2.0 * f.a * x + f.b - g.b) + 0.5 * cos2(f.b + g.b) * x) * (0.5 * cos2(f.d - g.d) * y + 0.25 / f.c * sin2(2.0 * f.c * y + f.d + g.d)));
            x = b2;
            y = b4;
            value += (f.amp * g.amp * (0.25 / f.a * sin2(2.0 * f.a * x + f.b - g.b) + 0.5 * cos2(f.b + g.b) * x) * (0.5 * cos2(f.d - g.d) * y + 0.25 / f.c * sin2(2.0 * f.c * y + f.d + g.d)));
            x = b1;
