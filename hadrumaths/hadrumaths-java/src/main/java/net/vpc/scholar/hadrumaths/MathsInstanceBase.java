...
//    public final TStoreManager<Matrix> MATRIX_STORE_MANAGER = new TStoreManager<Matrix>() {
//        @Override
...
//    };
//
//    public final TStoreManager<Vector> VECTOR_STORE_MANAGER = new TStoreManager<Vector>() {
//        @Override
...
//    public final TypeName<Matrix> $MATRIX = new TypeName(Matrix.class.getName());
//    public final TypeName<Vector> $VECTOR = new TypeName(Vector.class.getName());
...
//    public final TypeName<TList<Complex>> $CLIST = new TypeName(TList.class.getName(), $COMPLEX);
//    public final TypeName<TList<Expr>> $ELIST = new TypeName(TList.class.getName(), $EXPR);
//    public final TypeName<TList<Double>> $DLIST = new TypeName(TList.class.getName(), $DOUBLE);
//    public final TypeName<TList<TList<Double>>> $DLIST2 = new TypeName(TList.class.getName(), $DLIST);
//    public final TypeName<TList<Integer>> $ILIST = new TypeName(TList.class.getName(), $INTEGER);
//    public final TypeName<TList<Boolean>> $BLIST = new TypeName(TList.class.getName(), $BOOLEAN);
//    public final TypeName<TList<Matrix>> $MLIST = new TypeName(TList.class.getName(), $MATRIX);
...
//    public DistanceStrategy<Matrix> DISTANCE_MATRIX = new DistanceStrategy<Matrix>() {
//        @Override
//        public double distance(Matrix a, Matrix b) {
//            return a.getError(b);
//        }
//    };
//    public DistanceStrategy<Vector> DISTANCE_VECTOR = new DistanceStrategy<Vector>() {
//        @Override
...
//        return MathsInstanceBase.esum(seq(size, f));
//    }
//
...
//        return MathsInstanceBase.list($MATRIX, false, 0);
//    }
//
//    public TList<Matrix> mlist(int size) {
//        return MathsInstanceBase.list($MATRIX, false, size);
//    }
//
//    public TList<Matrix> mlist(Matrix... items) {
//        TList<Matrix> list = MathsInstanceBase.list($MATRIX, false, items.length);
...
//        return MathsInstanceBase.list($ELIST, false, 0);
//    }
//
//    public TList<TList<Double>> dlist2() {
//        return MathsInstanceBase.list($DLIST, false, 0);
//    }
//
//    public TList<TList<Integer>> ilist2() {
//        return MathsInstanceBase.list($ILIST, false, 0);
//    }
//
//    public TList<TList<Matrix>> mlist2() {
//        return MathsInstanceBase.list($MLIST, false, 0);
//    }
//
...
//        if (n.equals(MathsInstanceBase.CONE)) {
//            return a;
//        }
//        Expr mul = mul(a, n);
...
//        PlatformUtils.gc2();
//        MemoryInfo memoryInfoBefore = MathsInstanceBase.memoryInfo();
//        Chronometer c = new Chronometer().start();
//        r.run();
//        c.stop();
//        MemoryInfo memoryInfoAfter = MathsInstanceBase.memoryInfo();
//
//        PlatformUtils.gc2();
//        $log.log(Level.INFO, name + " : time= " + c.toString() + "  mem-usage= " + MathsInstanceBase.formatMemory(memoryInfoAfter.diff(memoryInfoBefore).inUseMemory()));
//        return c;
//    }
//
...
//            return (VectorSpace<T>) MathsInstanceBase.COMPLEX_VECTOR_SPACE;
//        }
//        if ($DOUBLE.isAssignableFrom(cls)) {
//            return (VectorSpace<T>) MathsInstanceBase.DOUBLE_VECTOR_SPACE;
//        }
//        if ($EXPR.isAssignableFrom(cls)) {
//            return (VectorSpace<T>) MathsInstanceBase.EXPR_VECTOR_SPACE;
//        }
...
//            return MathsInstanceBase.columnVector(new Complex[]{Complex.valueOf(value)});
//        }
//    }
//
...
//            return MathsInstanceBase.columnVector(new Complex[]{value});
//        }
//    }
//
...
////    }
////
////    private class TVectorTypeReference extends TypeName<TVector<Complex>> {
////    }
////
