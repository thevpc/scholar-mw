...
public static double primi_coslinear_old(Domain domain,CosXCosY f,Linear g){
  ...
  if (f.a == 0 && f.c == 0 && g.a == 0){
    x=b1;y=b3;value =(f.amp * cos2(f.b) * cos2(f.d)*g.b*x*y);
    x=b2;y=b4;value+=(f.amp * cos2(f.b) * cos2(f.d)*g.b*x*y);
    x=b1;y=b4;value-=(f.amp * cos2(f.b) * cos2(f.d)*g.b*x*y);
    x=b2;y=b3;value-=(f.amp * cos2(f.b) * cos2(f.d)*g.b*x*y);
    return value;

  }else if (f.a != 0 && f.c == 0 && g.a == 0){
    x=b1;y=b3;value =(f.amp * cos2(f.d)*g.b/f.a * sin2(f.a * x+f.b)*y);
    x=b2;y=b4;value+=(f.amp * cos2(f.d)*g.b/f.a * sin2(f.a * x+f.b)*y);
    x=b1;y=b4;value-=(f.amp * cos2(f.d)*g.b/f.a * sin2(f.a * x+f.b)*y);
    x=b2;y=b3;value-=(f.amp * cos2(f.d)*g.b/f.a * sin2(f.a * x+f.b)*y);
    return value;

  }else if (f.a == 0 && f.c != 0 && g.a == 0){
    x=b1;y=b3;value =(f.amp * cos2(f.b)*g.b*x/f.c * sin2(f.c * y+f.d));
    x=b2;y=b4;value+=(f.amp * cos2(f.b)*g.b*x/f.c * sin2(f.c * y+f.d));
    x=b1;y=b4;value-=(f.amp * cos2(f.b)*g.b*x/f.c * sin2(f.c * y+f.d));
    x=b2;y=b3;value-=(f.amp * cos2(f.b)*g.b*x/f.c * sin2(f.c * y+f.d));
    return value;

  }else if (f.a != 0 && f.c != 0 && g.a == 0){
    x=b1;y=b3;value =(f.amp*g.b/f.a * sin2(f.a * x+f.b)/f.c * sin2(f.c * y+f.d));
    x=b2;y=b4;value+=(f.amp*g.b/f.a * sin2(f.a * x+f.b)/f.c * sin2(f.c * y+f.d));
    x=b1;y=b4;value-=(f.amp*g.b/f.a * sin2(f.a * x+f.b)/f.c * sin2(f.c * y+f.d));
    x=b2;y=b3;value-=(f.amp*g.b/f.a * sin2(f.a * x+f.b)/f.c * sin2(f.c * y+f.d));
    return value;

  }else if (f.a == 0 && f.c == 0 && g.a != 0){
    x=b1;y=b3;value =(f.amp * cos2(f.b) * cos2(f.d)*(0.5*g.a*x*x+g.b*x)*y);
    x=b2;y=b4;value+=(f.amp * cos2(f.b) * cos2(f.d)*(0.5*g.a*x*x+g.b*x)*y);
    x=b1;y=b4;value-=(f.amp * cos2(f.b) * cos2(f.d)*(0.5*g.a*x*x+g.b*x)*y);
    x=b2;y=b3;value-=(f.amp * cos2(f.b) * cos2(f.d)*(0.5*g.a*x*x+g.b*x)*y);
    return value;

  }else if (f.a != 0 && f.c == 0 && g.a != 0){
    x=b1;y=b3;value =(f.amp * cos2(f.d)/f.a*(g.a/f.a* (cos2(f.a * x+f.b)+(f.a*x+f.b) * sin2(f.a * x+f.b))-g.a/f.a*f.b * sin2(f.a * x+f.b)+g.b * sin2(f.a * x+f.b))*y);
    x=b2;y=b4;value+=(f.amp * cos2(f.d)/f.a*(g.a/f.a* (cos2(f.a * x+f.b)+(f.a*x+f.b) * sin2(f.a * x+f.b))-g.a/f.a*f.b * sin2(f.a * x+f.b)+g.b * sin2(f.a * x+f.b))*y);
    x=b1;y=b4;value-=(f.amp * cos2(f.d)/f.a*(g.a/f.a* (cos2(f.a * x+f.b)+(f.a*x+f.b) * sin2(f.a * x+f.b))-g.a/f.a*f.b * sin2(f.a * x+f.b)+g.b * sin2(f.a * x+f.b))*y);
    x=b2;y=b3;value-=(f.amp * cos2(f.d)/f.a*(g.a/f.a* (cos2(f.a * x+f.b)+(f.a*x+f.b) * sin2(f.a * x+f.b))-g.a/f.a*f.b * sin2(f.a * x+f.b)+g.b * sin2(f.a * x+f.b))*y);
    return value;

  }else if (f.a == 0 && f.c != 0 && g.a != 0){
    x=b1;y=b3;value =(f.amp * cos2(f.b)*(0.5*g.a*x*x+g.b*x)/f.c * sin2(f.c * y+f.d));
    x=b2;y=b4;value+=(f.amp * cos2(f.b)*(0.5*g.a*x*x+g.b*x)/f.c * sin2(f.c * y+f.d));
    x=b1;y=b4;value-=(f.amp * cos2(f.b)*(0.5*g.a*x*x+g.b*x)/f.c * sin2(f.c * y+f.d));
    x=b2;y=b3;value-=(f.amp * cos2(f.b)*(0.5*g.a*x*x+g.b*x)/f.c * sin2(f.c * y+f.d));
    return value;

  }else{ //none is null
    x=b1;y=b3;value =(f.amp/f.a*(g.a/f.a* (cos2(f.a * x+f.b)+(f.a*x+f.b) * sin2(f.a * x+f.b))-g.a/f.a*f.b * sin2(f.a * x+f.b)+g.b * sin2(f.a * x+f.b))/f.c * sin2(f.c * y+f.d));
    x=b2;y=b4;value+=(f.amp/f.a*(g.a/f.a* (cos2(f.a * x+f.b)+(f.a*x+f.b) * sin2(f.a * x+f.b))-g.a/f.a*f.b * sin2(f.a * x+f.b)+g.b * sin2(f.a * x+f.b))/f.c * sin2(f.c * y+f.d));
    x=b1;y=b4;value-=(f.amp/f.a*(g.a/f.a* (cos2(f.a * x+f.b)+(f.a*x+f.b) * sin2(f.a * x+f.b))-g.a/f.a*f.b * sin2(f.a * x+f.b)+g.b * sin2(f.a * x+f.b))/f.c * sin2(f.c * y+f.d));
    x=b2;y=b3;value-=(f.amp/f.a*(g.a/f.a* (cos2(f.a * x+f.b)+(f.a*x+f.b) * sin2(f.a * x+f.b))-g.a/f.a*f.b * sin2(f.a * x+f.b)+g.b * sin2(f.a * x+f.b))/f.c * sin2(f.c * y+f.d));
    return value;
  }
}
//ENDING---------------------------------------
