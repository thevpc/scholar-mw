...
public class DBLargeMatrixFactory extends LargeMatrixFactory {
    ...
    protected void prepare() {
        try {
            ...
            log.log(Level.FINEST, getFactoryId() + " : sql = " + sql);
    ...
    public Matrix newMatrix(int rows, int columns) {
        ...
        try {
            ...
            log.log(Level.FINEST, getFactoryId() + " : sql = " + sql + " ; " + Arrays.asList(rows, columns, time));
...
//            ps.close();
    ...
    public Matrix findMatrix(long id) {
        try {
            ...
            log.log(Level.FINEST, getFactoryId() + " : sql = " + sql + " ; " + Arrays.asList(id));
            PreparedStatement ps = getConnection().prepareStatement(sql);
            ps.setLong(1, id);
...
//        System.out.println("get:" + row + " ," + col);
        ...
        try {
            ...
            log.log(Level.FINEST, getFactoryId() + " : sql = " + sql + " ; " + Arrays.asList(row, col));
...
//        System.out.println("get:" + row + " ," + col);
        ...
        try {
            ...
            log.log(Level.FINEST, getFactoryId() + " : sql = " + sql + " ; " + Arrays.asList(row, fromCol, toCol));
            PreparedStatement ps = preparedStatement(sql);
            ps.setInt(1, row);
            ps.setInt(2, fromCol);
            ps.setInt(3, toCol);
...
//        System.out.println("get:" + row + " ," + col);
        ...
        try {
            ...
            log.log(Level.FINEST, getFactoryId() + " : sql = " + sql + " ; " + Arrays.asList(column, fromRow, toRow));
            PreparedStatement ps = preparedStatement(sql);
            ps.setInt(1, column);
            ps.setInt(2, fromRow);
            ps.setInt(3, toRow);
...
//        System.out.println("set:" + row + " ," + col);
        if (isSparse() && getDefaultValue().equals(val)) {
            ...
            try {
                ...
                log.log(Level.FINEST, getFactoryId() + " : sql = " + sql + " ; " + Arrays.asList(val.getReal(), val.getImag(), row, col));
                PreparedStatement ps = preparedStatement(sql);
    ...
    public void resizeMatrix(long id, int rows, int columns) {
        try {
            ...
            log.log(Level.FINEST, getFactoryId() + " : sql = " + sql + " ; " + Arrays.asList(rows, columns, id));
            PreparedStatement ps = getConnection().prepareStatement(sql);
            ps.setInt(1, rows);
            ps.setInt(2, columns);
            ps.setLong(3, id);
