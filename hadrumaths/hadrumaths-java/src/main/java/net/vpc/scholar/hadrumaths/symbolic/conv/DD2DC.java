 ...
 */
public class DD2DC extends AbstractDoubleToComplex implements Cloneable {

    private static final long serialVersionUID = 1L;
    private static final DD2DC ZERO = new DD2DC(FunctionFactory.DZEROXY);
...
//    public DD2DC(IDDx real) {
//        this(new DDxToDDxy(real));
//    }

    public DD2DC(DoubleToDouble real) {
        this(real.getDomain(), real, FunctionFactory.DZEROXY);
//        name = (real.getName());
    }

    public DD2DC(DoubleToDouble real, DoubleToDouble imag) {
        this(real.getDomain(), real, imag);
//        name = (real.getName());
    }

    protected DD2DC(Domain domain, DoubleToDouble real, DoubleToDouble imag) {
        this.domain = domain;
...
//    }
//    public DD2DC(Domain domain) {
//        this.domain = domain;
//    }

    public static DD2DC valueOf(DoubleToDouble real) {
        if (real == null || real.isZero()) {
            return ZERO;
        }
        return new DD2DC(real);
    }

    public static DD2DC valueOf(DoubleToDouble real, DoubleToDouble imag) {
        if ((real == null || real.isZero()) && (imag == null || imag.isZero())) {
            return ZERO;
        }
        return new DD2DC(real, imag);
    }
...
//    }
    ...
    public Domain intersect(DD2DC other) {
        return domain.intersect(other.domain);
    }

    public Domain intersect(DD2DC other, Domain domain) {
//        return Domain.intersect(domain, other.domain, domain);
    ...
    public DoubleToComplex conj() {
        return MathsBase.complex(real, MathsBase.mul(MathsBase.expr(-1, Domain.FULL(getDomainDimension())), imag).toDD());
    }
...
//    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof DD2DC)) {
            return false;
        }
        DD2DC c = (DD2DC) obj;
    ...
    public Expr setParam(String name, Expr value) {
        ...
        if (!real.equals(this.real) || !(imag.equals(this.imag))) {
            Expr e = DD2DC.valueOf(real, imag);
    ...
    public Expr compose(Axis axis,Expr xreplacement) {
        DoubleToDouble real = this.real.compose(axis,xreplacement).toDD();
        DoubleToDouble imag = this.imag.compose(axis,xreplacement).toDD();
        if (!real.equals(this.real) || !(imag.equals(this.imag))) {
            Expr e = DD2DC.valueOf(real, imag);
            e = Any.copyProperties(this, e);
            return e;
