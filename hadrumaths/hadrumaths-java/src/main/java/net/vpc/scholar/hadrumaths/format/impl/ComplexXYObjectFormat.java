 ...
 * @author vpc
 */
public class ComplexXYObjectFormat implements ObjectFormat<ComplexValue> {
    public ComplexXYObjectFormat() {
    }

    @Override
    public String format(ComplexValue o, ObjectFormatParamSet format) {
...
//        }
    ...
    @Override
    public void format(StringBuilder sb, ComplexValue o, ObjectFormatParamSet format) {
