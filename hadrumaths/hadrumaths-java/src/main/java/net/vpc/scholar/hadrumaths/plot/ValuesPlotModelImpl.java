...
//    String PLOT_NAME_PROPERTY = "PLOT_NAME_PROPERTY";
     ...
     * @param plotType
     */
    public ValuesPlotModelImpl(String title, String xtitle, String ytitle, String ztitle, double[] x, double[] y, Complex[][] z, ComplexAsDouble converter, PlotType plotType, Map<String, Object> properties) {
     ...
     * @param converter
     */
    public ValuesPlotModelImpl(String title, String xtitle, String ztitle, String[] yTitles, double[][] x, Complex[][] z, ComplexAsDouble converter, PlotType plotType, Map<String, Object> properties) {
    ...
    public ValuesPlotModelImpl(String title, String xtitle, String ytitle, String ztitle, String[] ytitles, double[][] x, double[][] y, Complex[][] z, ComplexAsDouble converter, PlotType plotType, Map<String, Object> properties) {
        setTitle(title);
        setName(title);
        this.xtitle = xtitle;
        this.ytitle = ytitle;
...
//            changeSupport.firePropertyChange(DATA_PROPERTY, Boolean.FALSE, Boolean.TRUE);
    ...
    public ValuesPlotModelImpl setPreferredLibraries(Set<ExternalLibrary> preferredLibraries) {
    ...
    public ValuesPlotModelImpl setEnabledLibraries(Set<ExternalLibrary> enabledLibraries) {
