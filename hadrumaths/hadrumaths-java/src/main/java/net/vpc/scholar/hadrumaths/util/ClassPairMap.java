...
public class ClassPairMap<V> {
    ...
    public ClassPair[] evalHierarchy(ClassPair clazz) {
        Class[] first = ClassMap.findClassHierarchy(clazz.first, baseKey1Type);
        Class[] second = ClassMap.findClassHierarchy(clazz.second, baseKey2Type);
    ...
    protected static class ClassPair{
        ...
        private ClassPair(Class first, Class second) {
            this.first = first;
            this.second = second;
        }
