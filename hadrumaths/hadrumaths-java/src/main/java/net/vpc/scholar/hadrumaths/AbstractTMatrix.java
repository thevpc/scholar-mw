...
//    }
    ...
    @Override
    public List<TVector<T>> getRows() {
        return new AbstractList<TVector<T>>() {
            @Override
    ...
    @Override
    public List<TVector<T>> getColumns() {
        return new AbstractList<TVector<T>>() {
            @Override
            public TVector<T> get(int index) {
...
//    }
    ...
    protected abstract TMatrixFactory<T> createDefaultFactory();
