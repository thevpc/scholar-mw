...
import net.vpc.common.mon.DialogProgressMonitor;
import net.vpc.common.mon.ProgressMonitor;
import net.vpc.common.mon.ProgressMonitorFactory;
import net.vpc.common.mon.ProgressMonitorInputStream2;
import net.vpc.common.util.Chronometer;
import net.vpc.common.util.DatePart;
import net.vpc.common.util.TimeDuration;
import net.vpc.scholar.hadrumaths.Maths;
import net.vpc.scholar.hadrumaths.concurrent.AppLockException;
...
//    }
    ...
    public class CacheEvalBuilderImpl implements CacheEvalBuilder {
        ...
        @Override
        public CacheEvalBuilder init(Runnable init) {
            this.init = init;
            return this;
        }
