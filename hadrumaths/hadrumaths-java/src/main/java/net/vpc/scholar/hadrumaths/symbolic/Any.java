 ...
 * @author vpc
 */
public class Any extends AbstractVerboseExprRef implements Cloneable, DoubleToDouble, DoubleToComplex, DoubleToVector, DoubleToMatrix {
