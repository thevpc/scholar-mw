...
public class DefaultDoubleToMatrixNavRule implements ExpressionRewriterRule {
    ...
    public static final ExpressionRewriterRule INSTANCE = new DefaultDoubleToMatrixNavRule();
    public static final Class<? extends Expr>[] TYPES = new Class[]{DefaultDoubleToMatrix.class};
