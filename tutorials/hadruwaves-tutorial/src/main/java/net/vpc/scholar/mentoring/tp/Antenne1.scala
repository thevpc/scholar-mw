package net.vpc.scholar.mentoring.tp

import net.vpc.scholar.hadrumaths.Maths._
import net.vpc.scholar.hadrumaths.MathScala._
import net.vpc.scholar.hadrumaths.{Complex, Expr, MatrixCell, VectorCell}

object Antenne1 extends App{
 val π=PI
 var f=5.7*GHZ
 var λ=C/f
 val a=λ*10
