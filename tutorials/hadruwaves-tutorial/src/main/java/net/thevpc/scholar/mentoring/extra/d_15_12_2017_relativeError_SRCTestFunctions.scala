...
import net.thevpc.scholar.hadrumaths.MathScala.{C, Config, EPS0, FORMAL_SP, U0, X, Y, cos, domain, elist, esum, norm, normalize, param, sin, sqrt, vector}
import net.thevpc.scholar.hadrumaths.{InverseStrategy, Maths}
import net.thevpc.scholar.hadruplot.{Plot, PlotLines}
