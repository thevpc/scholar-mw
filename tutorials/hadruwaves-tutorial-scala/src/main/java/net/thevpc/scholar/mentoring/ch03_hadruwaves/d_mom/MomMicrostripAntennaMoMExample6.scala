...
import net.thevpc.scholar.hadruwaves.mom.SourceFactory._
import net.thevpc.scholar.hadruwaves.mom.MomParamFactory.axis._
import net.thevpc.scholar.hadruplot.PlotType._
