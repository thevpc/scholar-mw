...
import net.vpc.scholar.hadruwaves.studio.standalone.v1.editors.AreaRenderer;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.editors.DefaultAreaRenderer;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.editors.GridConfigEditor;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.editors.materials.AreaMaterialEditor;
...
public class MomProject2DPlotEditor extends JPanel {
    ...
    protected JComponent createToolbar() {
        ...
        drawSrcButton.setIcon(Resources.loadImageIcon("/net/vpc/scholar/hadruwaves/studio/standalone/v1/images/Source.gif"));
        drawMetalButton.setIcon(Resources.loadImageIcon("/net/vpc/scholar/hadruwaves/studio/standalone/v1/images/Metal.gif"));
        drawZsButton.setIcon(Resources.loadImageIcon("/net/vpc/scholar/hadruwaves/studio/standalone/v1/images/Zs.gif"));
        groupButton.setIcon(Resources.loadImageIcon("/net/vpc/scholar/hadruwaves/studio/standalone/v1/images/Group.gif"));
        ungroupButton.setIcon(Resources.loadImageIcon("/net/vpc/scholar/hadruwaves/studio/standalone/v1/images/Ungroup.gif"));
