...
import net.vpc.common.app.swing.actions.RedoAction;
import net.vpc.common.app.swing.actions.UndoAction;
import net.vpc.common.app.swing.core.swing.JFrameAppWindow;
import net.vpc.common.app.swingx.AppSwingxConfigurator;
import net.vpc.common.i18n.I18nResourceBundle;
import net.vpc.common.iconset.IconSet;
import net.vpc.common.iconset.ResourcesIconSet;
...
import net.vpc.common.swings.app.dock.mydoggy.MyDoggyAppDockingWorkspace;
...
import net.vpc.scholar.hadruwavesstudio.standalone.v2.actions.global.*;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.components.*;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.HWSUIPropsTool;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.cache.HWSCacheExplorerTool;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.console.HWSConsoleTool;
...
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.files.HWSFileExplorerTool;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.history.HWSProjectHistoryTool;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.library.HWSLibraryExplorerTool;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.locks.HWSLocksTool;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.logs.HWSLogTool;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.messages.HWSMessageTools;
...
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.tasks.HWSTasksTool;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.view3d.HWS3DView;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.view3d.actions.ResetCameraAction;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.view3d.actions.ZoomInAction;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.view3d.actions.ZoomOutAction;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.util.HWAppIconResolver;
...
//        ApplicationMenu
        ...
        app.i18n().bundles().add(new I18nResourceBundle(ResourceBundle.getBundle("net.vpc.scholar.hadruwavesstudio.standalone.v2.messages.HadruwavesStudio")));
        application = app;
        app.builder().mainWindowBuilder().get().workspaceFactory().set(MyDoggyAppDockingWorkspace.factory());

        app.start();

        app.iconSets().add(new ResourcesIconSet("Material-Neron-16", 16, 16, "/net/vpc/scholar/hadruwavesstudio/standalone/v2/images/material-mono", "png", getClass().getClassLoader()));
        app.iconSets().add(new ResourcesIconSet("Material-Neron-32", 32, 32, "/net/vpc/scholar/hadruwavesstudio/standalone/v2/images/material-mono", "png", getClass().getClassLoader()));
        app.iconSets().add(new ResourcesIconSet("Icon8-Simple-16", 16, 16, "/net/vpc/scholar/hadruwavesstudio/standalone/v2/images/icons8-color", "png", getClass().getClassLoader()));
        app.iconSets().add(new ResourcesIconSet("Icon8-Simple-32", 32, 32, "/net/vpc/scholar/hadruwavesstudio/standalone/v2/images/icons8-color", "png", getClass().getClassLoader()));
...
//        tools.addAction("/mainWindow/menuBar/File/ClearAllCache");
    ...
    protected void prepareMenu_Edit() {
        ...
        tools.addAction(new PasteAction(application, this), "/mainWindow/menuBar/Edit/Paste", "/mainWindow/toolBar/Default/Paste");
