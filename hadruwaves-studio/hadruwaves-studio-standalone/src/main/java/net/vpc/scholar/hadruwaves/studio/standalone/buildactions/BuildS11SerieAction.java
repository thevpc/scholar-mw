 ...
 * Time: 00:33:09
 */
public class BuildS11SerieAction extends RunAction {
    ...
    public BuildS11SerieAction(MomStrHelper jxy,String iteratorName,double[] freqs,int index1,int index2) {
        this.jxy = jxy;
        this.freqs=freqs;
        this.index1=index1;
        this.index2=index2;
    ...
    public Object run() {
        ...
        for (int i = 0; i < complexes.length; i++) {
            ...
            jxy.recompile();
            complexes[i] = jxy.computeS(ProgressMonitorFactory.none()).get(index1,index2);
            if (i > 0) {
