package net.vpc.scholar.hadruwaves.studio.standalone.panels;
...
import net.vpc.scholar.hadruwaves.studio.standalone.editors.AreaRenderer;
import net.vpc.scholar.hadruwaves.studio.standalone.editors.DefaultAreaRenderer;
import net.vpc.scholar.hadruwaves.studio.standalone.editors.GridConfigEditor;
import net.vpc.scholar.hadruwaves.studio.standalone.editors.materials.AreaMaterialEditor;
...
public class MomProject2DPlotEditor extends JPanel {
    ...
    protected JComponent createToolbar() {
        ...
        drawSrcButton.setIcon(Resources.loadImageIcon("/net/vpc/research/tmwlab/resources/images/Source.gif"));
        drawMetalButton.setIcon(Resources.loadImageIcon("/net/vpc/research/tmwlab/resources/images/Metal.gif"));
        drawZsButton.setIcon(Resources.loadImageIcon("/net/vpc/research/tmwlab/resources/images/Zs.gif"));
        groupButton.setIcon(Resources.loadImageIcon("/net/vpc/research/tmwlab/resources/images/Group.gif"));
        ungroupButton.setIcon(Resources.loadImageIcon("/net/vpc/research/tmwlab/resources/images/Ungroup.gif"));
