...
public class TMWLabApplication extends DefaultApplication {
    ...
    public static void main(String args[]) {
        ApplicationLoader.init(new SplashScreenObserver(7, "/net/vpc/research/tmwlab/resources/images/splashscreen.gif"));
    ...
    protected void setupStartup() {
        super.setupStartup();
        getResources().loadBundle("net.vpc.research.tmwlab.resources.messages.TMWLabApplication");
    }
