...
import net.vpc.scholar.hadruwaves.studio.standalone.VarList;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.AllTasksAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.RunningProjectThread;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrBuildAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrEstimateMNAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrListCacheAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrOpenCacheAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrPlotConvengenceJCoeffAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrPlotDurationJCoeffAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrPlotEBaseAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrPlotJBaseAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrPlotJTestingAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrPlotJcoeffsAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrPlotS11Action;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrPlotSourceAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrPlotZinAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrS11Action;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrSaveAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrSaveAsAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrZinAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StructureStopAllAction;
import net.vpc.scholar.hadruwaves.studio.standalone.panels.MomProject2DPlotEditor;
import net.vpc.scholar.hadruwaves.studio.standalone.TMWLabApplication;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrCapacityAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrDumpAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrPlotCapacityAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrShowAMatrixAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrShowBMatrixAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrShowFnAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrShowGpAction;
import net.vpc.scholar.hadruwaves.studio.standalone.actions.StrShowGpFnSpAction;
...
import static net.vpc.scholar.hadruwaves.mom.BoxLimit.NOTHING;
...
import net.vpc.scholar.hadruwaves.studio.core.HWSTools;
...
//        });
        ...
        actionsStopButton.setIcon(Resources.loadImageIcon("/net/vpc/research/tmwlab/resources/images/Stop.gif"));
        b.add(progressBar);
        b.add(actionsButton);
