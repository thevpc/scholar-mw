...
import net.vpc.scholar.hadruwaves.studio.standalone.v1.VarList;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.AllTasksAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.RunningProjectThread;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrBuildAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrEstimateMNAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrListCacheAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrOpenCacheAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrPlotConvengenceJCoeffAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrPlotDurationJCoeffAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrPlotEBaseAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrPlotJBaseAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrPlotJTestingAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrPlotJcoeffsAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrPlotS11Action;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrPlotSourceAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrPlotZinAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrS11Action;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrSaveAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrSaveAsAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrZinAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StructureStopAllAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.panels.MomProject2DPlotEditor;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.TMWLabApplication;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrCapacityAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrDumpAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrPlotCapacityAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrShowAMatrixAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrShowBMatrixAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrShowFnAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrShowGpAction;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.actions.StrShowGpFnSpAction;
...
import net.vpc.scholar.hadruwaves.studio.standalone.v1.HWSTools;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.MomUIFactory;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.editors.areashapes.RectAreaShapeEditor;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.editors.gpmeshs.BoxModesGpMesherEditor;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.editors.gpmeshs.ConstantGpMesherEditor;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.editors.gpmeshs.RooftopGpMesherEditor;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.editors.materials.ModalSourceMaterialEditor;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.editors.materials.PecMaterialEditor;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.editors.materials.PlanarSourceMaterialEditor;
import net.vpc.scholar.hadruwaves.studio.standalone.v1.editors.materials.SurfaceImpedanceMaterialEditor;
...
//        });
        ...
        actionsStopButton.setIcon(Resources.loadImageIcon("/net/vpc/scholar/hadruwaves/studio/standalone/v1/images/Stop.gif"));
        b.add(progressBar);
        b.add(actionsButton);
...
//        }
    ...
    private class LayersPanel extends JPanel {
        ...
        public LayersPanel() {
            ...
            bottomLimitType = (ECComboBox) DataTypeEditorFactory.forEnum("bottomLimitType", BoxLimit.class, false, getResources());
            bottomLimitType.getHelper().setObject(BoxLimit.SHORT);
            ...
            topLimitType = (ECComboBox) DataTypeEditorFactory.forEnum("topLimitType", BoxLimit.class, false, getResources());
            topLimitType.getHelper().setDescription(getResources().get("topLimitType"));
            topLimitType.getHelper().setObject(BoxLimit.SHORT);
        ...
        public void store(MomProject str) {
            str.getLayers().setTopLimit((BoxLimit) topLimitType.getHelper().getObject());
            str.getLayers().setBottomLimit((BoxLimit) bottomLimitType.getHelper().getObject());
        ...
        private void revalidateAll() {
            if (ProjectType.PLANAR_STRUCTURE.equals(projectType.getHelper().getObject())) {
                ...
                BoxLimit top = (BoxLimit) topLimitType.getHelper().getObject();
                switch (top) {
                    case MATCHED_LOAD: {
                ...
                BoxLimit bottom = (BoxLimit) bottomLimitType.getHelper().getObject();
                switch (bottom) {
                    case MATCHED_LOAD: {
                ...
                bottomLimitType.getHelper().setObject(BoxLimit.MATCHED_LOAD);
                topLimitType.getHelper().setObject(BoxLimit.MATCHED_LOAD);
            }
        }
    }
    ...
    private class BoxPanel extends JPanel {
        ...
        public BoxPanel() {
            super(new BorderLayout());
            wallBorderNorth = (ECComboBox) DataTypeEditorFactory.forEnum("wallBorderNorth", Wall.class, false, null);
            wallBorderNorth.getHelper().setDescription("Mur du Nord");
            wallBorderNorth.getHelper().setObject(Wall.ELECTRIC);
            wallBorderSouth = (ECComboBox) DataTypeEditorFactory.forEnum("wallBorderSouth", Wall.class, false, null);
            wallBorderSouth.getHelper().setDescription("Mur du Sud");
            wallBorderSouth.getHelper().setObject(Wall.ELECTRIC);
            wallBorderWest = (ECComboBox) DataTypeEditorFactory.forEnum("wallBorderWest", Wall.class, false, null);
            wallBorderWest.getHelper().setDescription("Mur du Ouest");
            wallBorderWest.getHelper().setObject(Wall.ELECTRIC);
            wallBorderEast = (ECComboBox) DataTypeEditorFactory.forEnum("wallBorderEast", Wall.class, false, null);
            wallBorderEast.getHelper().setDescription("Mur de l'Est");
            wallBorderEast.getHelper().setObject(Wall.ELECTRIC);
        ...
        public void store(MomProject str) {
            str.setWallBorders(
                    WallBorders.valueOf(
                            (Wall) (wallBorderNorth.getHelper().getObject()),
                            (Wall) (wallBorderEast.getHelper().getObject()),
                            (Wall) (wallBorderSouth.getHelper().getObject()),
                            (Wall) (wallBorderWest.getHelper().getObject())));
