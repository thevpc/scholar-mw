...
import net.vpc.scholar.hadruwaves.studio.standalone.editors.areashapes.AreaShapeEditorPanel;
import net.vpc.scholar.hadruwaves.studio.standalone.editors.materials.AreaMaterialEditorPanel;
