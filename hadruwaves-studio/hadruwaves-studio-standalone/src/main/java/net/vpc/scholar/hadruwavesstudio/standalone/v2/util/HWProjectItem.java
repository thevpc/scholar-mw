...
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.props.trees.HWProjectElementBrickPropertiesAware;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.props.trees.MaterialPropertiesAware;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.props.trees.HWProjectElementPropertiesAware;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.props.trees.MaterialBrickFacePropertiesAware;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.props.trees.HWMaterialTemplatePropertiesAware;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.props.trees.HWProjectElementMaterialPropertiesAware;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.props.trees.HWSolutionPropertiesAware;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.props.trees.HWProjectPropertiesAware;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.props.trees.HWSolutionElementPropertiesAware;
...
import net.vpc.scholar.hadruwaves.project.scene.AbstractHWProjectComponentMaterial;
...
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.props.trees.HWProjectConfigurationPropertiesAware;
import net.vpc.scholar.hadruwavesstudio.standalone.v2.tools.props.trees.HWProjectFolderPropertiesAware;
