 ...
 * @author vpc
 */
public class MoMTestFunctions extends AbstractHWSolverAction {

    public MoMTestFunctions() {
        super("MoMTestFunctions", "Test Functions", "/MoM Solver/Build/Test Functions", "Build");
    }
