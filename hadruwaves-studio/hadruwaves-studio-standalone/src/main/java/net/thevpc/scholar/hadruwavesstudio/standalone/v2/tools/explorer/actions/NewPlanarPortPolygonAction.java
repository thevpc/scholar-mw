 ...
 * @author vpc
 */
public class NewPlanarPortPolygonAction extends SwingAppUndoableAction {

    private final HWSSolutionExplorerTool explorer;

    public NewPlanarPortPolygonAction(final HWSSolutionExplorerTool outer) {
        super(outer.app(), "NewPlanarPortPolygon");
        this.explorer = outer;
