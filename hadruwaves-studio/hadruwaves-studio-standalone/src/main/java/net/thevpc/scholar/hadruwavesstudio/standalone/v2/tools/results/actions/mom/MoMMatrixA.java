 ...
 * @author vpc
 */
public class MoMMatrixA extends AbstractHWSolverAction {

    public MoMMatrixA() {
        super("TestMatrixA", "Matrix A", "/MoM Solver/Build/Matrix A", "Build");
    }
    ...
    public void run(HWSolverActionContext context) {
        ...
        context.app().runWorker(() -> {
            ...
            Object result = solver.str().matrixA().evalMatrix();
