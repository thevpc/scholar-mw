 ...
 * @author vpc
 */
public class MoMHFieldSphereAction extends AbstractHWSolverAction {

    ThetaPhiRSamplesDialog polardialog;

    public MoMHFieldSphereAction(ThetaPhiRSamplesDialog polardialog) {
        super("MoMHFieldSpherical", "H Field Spherical", "/MoM Solver/H Field/H Field Spherical", "Build");
