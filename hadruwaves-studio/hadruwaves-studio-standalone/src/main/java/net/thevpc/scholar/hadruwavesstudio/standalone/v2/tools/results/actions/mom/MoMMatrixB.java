 ...
 * @author vpc
 */
public class MoMMatrixB extends AbstractHWSolverAction {

    public MoMMatrixB() {
        super("TestMatrixB", "Matrix B", "/MoM Solver/Build/Matrix B", "Build");
    }
    ...
    public void run(HWSolverActionContext context) {
        ...
        context.app().runBack(() -> {
            ...
            Object result = solver.str().matrixB().evalMatrix();
