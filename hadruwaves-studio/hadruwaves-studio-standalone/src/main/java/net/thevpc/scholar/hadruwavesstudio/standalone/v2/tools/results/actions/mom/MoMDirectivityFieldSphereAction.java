 ...
 * @author vpc
 */
public class MoMDirectivityFieldSphereAction extends AbstractHWSolverAction {

    ThetaPhiRSamplesDialog polardialog;

    public MoMDirectivityFieldSphereAction(ThetaPhiRSamplesDialog polardialog) {
        super("MoMDirectivitySpherical", "Directivity Spherical", "/MoM Solver/Power/Directivity Spherical", "Build");
