 ...
 * @author vpc
 */
public class MoMEFieldSphereModuleAction extends AbstractHWSolverAction {

    ThetaPhiRSamplesDialog polardialog;

    public MoMEFieldSphereModuleAction(ThetaPhiRSamplesDialog polardialog) {
        super("MoMEFieldSphericalModule", "E Field Module", "/MoM Solver/E Field/E Field Module", "Build");
    ...
    public void run(HWSolverActionContext context) {
        ...
        if (polardialog.show()) {
            ...
            if (r != null) {
                String icon="Chart";
                Object result = solver.electricField().spherical()
                        .evalModuleMatrix(
