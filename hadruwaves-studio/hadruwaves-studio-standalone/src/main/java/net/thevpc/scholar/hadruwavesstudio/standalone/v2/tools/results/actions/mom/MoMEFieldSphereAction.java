 ...
 * @author vpc
 */
public class MoMEFieldSphereAction extends AbstractHWSolverAction {

    ThetaPhiRSamplesDialog polardialog;

    public MoMEFieldSphereAction(ThetaPhiRSamplesDialog polardialog) {
        super("MoMEFieldSpherical", "E Field Spherical", "/MoM Solver/E Field/E Field Spherical", "Build");
