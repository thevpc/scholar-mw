...
public class MaterialPropertiesAware extends DefaultHWPropertiesTree {
    ...
    public void refresh() {
        ...
        folder.add(new PValueViewProperty("property", outer.getStudio().app(), Props.of("permittivity").valueOf(Double.class, wp.permittivity()).readOnly()));
        ...
        folder.add(new PValueViewProperty("property", outer.getStudio().app(), Props.of("electricConductivity").valueOf(Double.class, wp.electricConductivity()).readOnly()));
    }
