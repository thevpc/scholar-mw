 ...
 * @author vpc
 */
public class MoMMatrixX extends AbstractHWSolverAction {

    public MoMMatrixX() {
        super("TestMatrixX", "Matrix X", "/MoM Solver/Build/Matrix X", "Build");
    }
    ...
    public void run(HWSolverActionContext context) {
        ...
        context.app().runWorker(() -> {
            ...
            Object result = solver.str().matrixX().evalMatrix();
