 ...
 */
package net.thevpc.scholar.hadruwavesstudio.standalone.v2.tools.results.dialogs;

import javax.swing.JComponent;
import net.thevpc.scholar.hadruwaves.project.configuration.HWConfigurationRun;
import net.thevpc.scholar.hadruwavesstudio.standalone.v2.components.AppDialog;
import net.thevpc.scholar.hadruwavesstudio.standalone.v2.components.AppForm;
import net.thevpc.scholar.hadruwavesstudio.standalone.v2.components.AppFormBuilder;
