...
import net.thevpc.scholar.hadruwavesstudio.standalone.v1.editors.areashapes.AreaShapeEditorPanel;
import net.thevpc.scholar.hadruwavesstudio.standalone.v1.editors.materials.AreaMaterialEditorPanel;
