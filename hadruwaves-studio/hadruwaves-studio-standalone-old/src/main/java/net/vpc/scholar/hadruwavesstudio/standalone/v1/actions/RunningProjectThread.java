...
public class RunningProjectThread extends Thread {
    ...
    private net.thevpc.scholar.hadruwaves.mom.project.common.RunAction runAction;
    ...
    public void setRunAction(net.thevpc.scholar.hadruwaves.mom.project.common.RunAction runAction) {
