...
public class TMWLabApplication extends DefaultApplication {
    ...
    public static void main(String args[]) {
        ApplicationLoader.init(new SplashScreenObserver(7, "/net/thevpc/scholar/hadruwavesstudio/standalone/v1/images/splashscreen.gif"));
    ...
    protected void setupStartup() {
        super.setupStartup();
        getResources().loadBundle("net.thevpc.scholar.hadruwaves.studio.standalone.v1.messages.TMWLabApplication");
    }
